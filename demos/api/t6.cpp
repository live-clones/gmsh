...
int main(int argc, char **argv)
{
  ...
  factory::mesh::setTransfiniteLine(2, 20, "Bump", 0.05);
  ...
  // on curve 3
  factory::mesh::setTransfiniteLine(1, 30, "Progression", -1.2);
  factory::mesh::setTransfiniteLine(3, 30, "Progression", 1.2);
