...
gmsh.option.setNumber('Mesh.MeshSizeFactor',1.3);
gmsh.model.mesh.generate(3)


gmsh.plugin.setString('BoundaryLayer','Surfaces','7,8,9,10')
gmsh.plugin.setString('BoundaryLayer','Volumes','1')
gmsh.plugin.setNumber('BoundaryLayer','Thickness',1/3.)
gmsh.plugin.setNumber('BoundaryLayer','Size',1./250.)
gmsh.plugin.setNumber('BoundaryLayer','Ratio',1.3)
