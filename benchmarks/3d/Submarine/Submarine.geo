...
Characteristic Length {14, 13, 15, 16, 10, 9, 11, 12, 6, 5, 19, 8, 4, 3, 7, 2, 1} = 40;
Characteristic Length {21} = 80;
Characteristic Length {17, 18} = 40;
Characteristic Length {20} = 80;

Compound Line(34) = {22, 23, 24, 25};
