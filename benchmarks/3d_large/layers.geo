...
Circle(23) = {24, 11, 25};
Circle(24) = {25, 11, 22};
Point(31) = {0, 0, h2+h1, cl};
Point(32) = {r2, 0, h2+h1, cl};
Point(33) = {0, r2, h2+h1, cl};
Point(34) = {-r2, 0, h2+h1, cl};
Point(35) = {0, -r2, h2+h1, cl};
Circle(31) = {32, 31, 33};
Circle(32) = {33, 31, 34};
Circle(33) = {34, 31, 35};
Circle(34) = {35, 31, 32};
