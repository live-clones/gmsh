...
../../bin/gmsh 15_cylinder_head.brep -v 0 -2 -clscale .1 -append_statreport statreport.dat
../../bin/gmsh sphere_Rhino3D_default.geo -clscale 1 -v 0 -2 -append_statreport statreport.dat
