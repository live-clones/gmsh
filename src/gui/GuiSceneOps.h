...
// What a 3D scene answers, written once and used three ways: to declare
// the table a scene fills, to write the functions GuiScene.h promises, and
// to fill that table from a scene's own functions.
//
// Three lists, because what a function gives back decides what happens
// when no scene has it: nothing at all, a value that stands for nothing,
// or an empty list one may take a reference to.
