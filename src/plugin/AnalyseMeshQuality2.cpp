...
std::string Plug::getHelp() const
{
  ...
  return
    ...
    "meshes, the plot exhibits abrupt jumps on the left part. This is normal "
    "and expected. The first jump corresponds to the transition from the worst "
    "value to the second worst value and provides an idea of the number of "
    ...
    "-- `-1': Typically used for scripting, where only the resulting statistics are desired.\n"
