...
// The bar along the bottom of the window: a row of buttons and, taking
// whatever width is left, the last message and the progress of what is
// running.
...
void appWindow::_drawStatusBar()
{
  ...
  if(ImGui::BeginViewportSideBar("##gmshStatusBar", (ImGuiViewport *)viewport,
    ...
    if(ImGui::BeginMenuBar()) {
      ...
      // --- what is left of the bar: the message and the progress. Clicking
      // shows or hides the console; the target is the whole strip left of the
