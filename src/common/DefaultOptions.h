...
StringXNumber GeometryOptions_Number[] = {
  ...
  {F | O, "OCCBooleanGlue", opt_geometry_occ_boolean_glue, 0.,
   ...
   "allow shapes with partial overlaps, 2: only allow shapes with full coincidence)"},
  ...
  {F | O, "OCCFastUnbind", opt_geometry_occ_fast_unbind, 1.,
   ...
   "entities in geometrical transformations (1), as well as in boolean "
   "operations (2)"},
...
StringXNumber MeshOptions_Number[] = {
  ...
  {F | O, "FlexibleTransfinite", opt_mesh_flexible_transfinite, 0,
   ...
   "Blossom) or by global mesh size factor"},
  {F | O, "Format", opt_mesh_file_format, FORMAT_AUTO,
   ...
   "diff, 38: ir3, 39: inp, 40: ply2, 41: celum, 42: su2, 47: tochnog, 49: neu, "
   "50: matlab)"},
  ...
  {F | O, "IgnoreUnknownSections", opt_mesh_ignore_unknown_sections, 0.,
   ...
   "the contents of these sections are stored as model attributes)"},
  ...
  {F | O, "MeshSizeExtendFromBoundary", opt_mesh_lc_extend_from_boundary, 1.,
   ...
   "interior (0: never; 1: for surfaces and volumes; 2: for surfaces and "
   "volumes, but use smallest surface element edge length instead of longest "
   "length in 3D Delaunay; "
  ...
  {F | O, "MinQuality", opt_mesh_min_quality, 0.,
   ...
   "generation of the current mesh (read-only)"},
  ...
  {F | O, "PartitionCreateGhostCells", opt_mesh_partition_create_ghost_cells, 0,
   ...
   "containing elements connected to neighboring partitions by at least one "
   "node."},
  ...
  {F | O, "SaveWithoutOrphans", opt_mesh_save_without_orphans, 0.,
   ...
   "entity in the model) in MSH4 files"},
  ...
  {F | O, "SecondOrderLinear", opt_mesh_second_order_linear, 0.,
   ...
   "algorithms) simply be created by linear interpolation?"},
  ...
  {F | O, "StlLinearDeflection", opt_mesh_stl_linear_deflection, 0.001,
   ...
   "entities (currently only used with the OpenCASCADE kernel)"},
  {F | O, "StlLinearDeflectionRelative",
   ...
   "length of curves (currently only used with the OpenCASCADE kernel)"},
  ...
  {F | O, "StlRemoveBadTriangles", opt_mesh_stl_remove_bad_triangles, 0.,
   ...
   "remove duplicate and zero-area triangles)"},
...
StringXNumber PostProcessingOptions_Number[] = {
  ...
  {F | O, "Link", opt_post_link, 0.,
   ...
   "views, 1: force same options for all selected views)"},
...
StringXNumber ViewOptions_Number[] = {
  ...
  {F | O, "AutoPosition", opt_view_auto_position, 1.,
   ...
   "top left, 3: top right, 4: bottom left, 5: bottom right, 6: top, 7: bottom, "
   "8: left, 9: right, 10: full, 11: top third, 12: in model coordinates)"},
  ...
  {F | O, "ShowTime", opt_view_show_time, 3.,
   ...
   "automatic, 4: step data, 5: multi-step data, 6: real eigenvalues, "
  ...
  {F | O, "TensorType", opt_view_tensor_type, 1.,
   ...
   "eigenvalue, 4: eigenvectors, 5: ellipse, 6: ellipsoid, 7: frame (box), "
   "8: frame (vectors))"},
