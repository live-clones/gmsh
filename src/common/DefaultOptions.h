...
StringXString GeneralOptions_String[] = {
  ...
  {F | O, "AxesLabelX", opt_general_axes_label0, "", "X-axis label"},
  {F | O, "AxesLabelY", opt_general_axes_label1, "", "Y-axis label"},
  {F | O, "AxesLabelZ", opt_general_axes_label2, "", "Z-axis label"},
  ...
  {F | S, "OptionsFileName", opt_general_options_filename,
   ...
   ".gmsh-options",
#endif
   "Option file created with `Tools->Options->Save'; automatically read on "
   "startup"},
  ...
  {0, "SessionFileName", opt_general_session_filename,
   ...
   ".gmshrc",
#endif
   "Option file into which session specific information is saved; "
   "automatically "
   "read on startup"},
  {F | O, "ScriptingLanguages", opt_general_scripting_languages, "geo",
   "Language(s) in which scripting commands generated by the GUI are written"},
  ...
  {F, "Version", opt_general_version, "", "Gmsh version (read-only)"},
...
StringXString GeometryOptions_String[] = {
  {F | O, "DoubleClickedPointCommand",
   opt_geometry_double_clicked_point_command, "ONELAB",
   "Command parsed when double-clicking on a point, or 'ONELAB' "
   "to edit associated ONELAB parameters"},
  {F | O, "DoubleClickedCurveCommand",
   opt_geometry_double_clicked_curve_command, "ONELAB",
   "Command parsed when double-clicking on a curve, or 'ONELAB' "
   "to edit associated ONELAB parameters"},
  {F | O | D, "DoubleClickedLineCommand",
   opt_geometry_double_clicked_curve_command, "ONELAB", "[Deprecated]"},
  {F | O, "DoubleClickedSurfaceCommand",
   opt_geometry_double_clicked_surface_command, "ONELAB",
   "Command parsed when double-clicking on a surface, or 'ONELAB' "
   "to edit associated ONELAB parameters"},
  {F | O, "DoubleClickedVolumeCommand",
   opt_geometry_double_clicked_volume_command, "ONELAB",
   "Command parsed when double-clicking on a volume, or 'ONELAB' "
   "to edit associated ONELAB parameters"},

  {F | O, "OCCTargetUnit", opt_geometry_occ_target_unit, "",
   "Length unit to which coordinates from STEP and IGES files are converted to "
   "when "
   "imported by OpenCASCADE, e.g. 'M' for meters (leave empty to use the "
   "default "
   "OpenCASCADE behavior); the option should be set before importing the STEP "
   "or "
   "IGES file"},
  ...
  {F | O, "OCCSTEPImplementationLevel",
   opt_geometry_occ_step_implementation_level, "",
  ...
  {F | O, "OCCSTEPOrganization", opt_geometry_occ_step_organization, "",
   ...
   "If left empty, the default value is set by OpenCASCADE"},
  {F | O, "OCCSTEPPreprocessorVersion",
   opt_geometry_occ_step_preprocessor_version, "",
...
StringXString MeshOptions_String[] = {{0, nullptr, nullptr, "", nullptr}};
...
StringXString SolverOptions_String[] = {
  ...
  {F | S, "Name0", opt_solver_name0, "GetDP", "Name of solver 0"},
  {F | S, "Name1", opt_solver_name1, "", "Name of solver 1"},
  {F | S, "Name2", opt_solver_name2, "", "Name of solver 2"},
  {F | S, "Name3", opt_solver_name3, "", "Name of solver 3"},
  {F | S, "Name4", opt_solver_name4, "", "Name of solver 4"},
  {F | S, "Name5", opt_solver_name5, "", "Name of solver 5"},
  {F | S, "Name6", opt_solver_name6, "", "Name of solver 6"},
  {F | S, "Name7", opt_solver_name7, "", "Name of solver 7"},
  {F | S, "Name8", opt_solver_name8, "", "Name of solver 8"},
  {F | S, "Name9", opt_solver_name9, "", "Name of solver 9"},
  ...
  {F | S, "PythonInterpreter", opt_solver_python_interpreter, "python",
   "Name of the Python interpreter (used to run .py files if they are not "
   "executable)"},
...
#endif
   "Base name of socket (UNIX socket if the name does not contain a colon, "
   "TCP/IP "
   "otherwise, in the form 'host:baseport'; the actual name/port is "
   "constructed "
   "by appending the unique client id. If baseport is 0 or is not provided, "
   "the "
...
StringXString PostProcessingOptions_String[] = {
  {F | O, "DoubleClickedGraphPointCommand",
...
StringXString ViewOptions_String[] = {
  {F | O, "Attributes", opt_view_attributes, "",
   "Optional string attached to the view. If the string contains "
   "'AlwaysVisible', "
  ...
  {F | O, "AxesFormatZ", opt_view_axes_format2, "%.3g",
   "Number format for Z-axis (in standard C form)"},
  {F | O, "AxesLabelX", opt_view_axes_label0, "", "X-axis label"},
  {F | O, "AxesLabelY", opt_view_axes_label1, "", "Y-axis label"},
  {F | O, "AxesLabelZ", opt_view_axes_label2, "", "Z-axis label"},
  ...
  {F | O | D, "Format", opt_view_number_format, "%.3g", "[Deprecated]"},
  ...
  {F | O, "GeneralizedRaiseZ", opt_view_gen_raise2, "v2",
   ...
   "using formula possibly containing x, y, z, s[tep], t[ime], v0, ... v8)"},
  {F | O, "Group", opt_view_group, "", "Group to which this view belongs"},

  {F, "Name", opt_view_name, "", "Default post-processing view name"},
  {F | O, "NumberFormat", opt_view_number_format, "%.3g",
   "Number format (in standard C form)"},

  {F | O, "Stipple0", opt_view_stipple0, "1*0x1F1F", "First stippling pattern"},
  {F | O, "Stipple1", opt_view_stipple1, "1*0x3333",
   "Second stippling pattern"},
  {F | O, "Stipple2", opt_view_stipple2, "1*0x087F", "Third stippling pattern"},
  {F | O, "Stipple3", opt_view_stipple3, "1*0xCCCF",
   "Fourth stippling pattern"},
  {F | O, "Stipple4", opt_view_stipple4, "2*0x1111", "Fifth stippling pattern"},
  {F | O, "Stipple5", opt_view_stipple5, "2*0x0F0F", "Sixth stippling pattern"},
  ...
  {F | O, "Stipple8", opt_view_stipple8, "2*0x087F", "Ninth stippling pattern"},
  {F | O, "Stipple9", opt_view_stipple9, "1*0xFFFF", "Tenth stippling pattern"},
...
StringXNumber GeneralOptions_Number[] = {
  ...
  {F | O, "Axes", opt_general_axes, 0.,
   "Axes (0: none, 1: simple axes, 2: box, 3: full grid, 4: open grid, 5: "
   "ruler)"},
  {F | O, "AxesMikado", opt_general_axes_mikado, 0., "Mikado axes style"},
  ...
  {F | O, "AxesMaxX", opt_general_axes_xmax, 1., "Maximum X-axis coordinate"},
  {F | O, "AxesMaxY", opt_general_axes_ymax, 1., "Maximum Y-axis coordinate"},
  {F | O, "AxesMaxZ", opt_general_axes_zmax, 1., "Maximum Z-axis coordinate"},
  {F | O, "AxesMinX", opt_general_axes_xmin, 0., "Minimum X-axis coordinate"},
  {F | O, "AxesMinY", opt_general_axes_ymin, 0., "Minimum Y-axis coordinate"},
  {F | O, "AxesMinZ", opt_general_axes_zmin, 0., "Minimum Z-axis coordinate"},
  ...
  {F | O, "BackgroundImagePositionY", opt_general_background_image_position1, 0,
   "Y position of background image (for 2D background: < 0: measure from "
   "bottom window edge; "
   ">= 1e5: centered)"},
  {F | O, "BackgroundImageWidth", opt_general_background_image_size0, -1.,
   "Width of background image (0: actual width if height = 0, natural scaling "
   "if not; "
   "-1: graphic window width)"},
  {F | O, "BackgroundImageHeight", opt_general_background_image_size1, -1,
   "Height of background image (0: actual height if width = 0, natural scaling "
   "if not; "
   "-1: graphic window height)"},
  {F | O, "BoundingBoxSize", opt_general_lc, 1.,
   "Overall bounding box size (read-only)"},

  {F | O, "Camera", opt_general_camera_mode, 0., "Enable camera view mode"},
  ...
  {F, "Clip0A", opt_general_clip0a, 1.0,
   "First coefficient in equation for clipping plane 0 (`A' in "
   "`AX+BY+CZ+D=0')"},
  {F, "Clip0B", opt_general_clip0b, 0.0,
   "Second coefficient in equation for clipping plane 0 (`B' in "
   "`AX+BY+CZ+D=0')"},
  {F, "Clip0C", opt_general_clip0c, 0.0,
   "Third coefficient in equation for clipping plane 0 (`C' in "
   "`AX+BY+CZ+D=0')"},
  {F, "Clip0D", opt_general_clip0d, 0.0,
   "Fourth coefficient in equation for clipping plane 0 (`D' in "
   "`AX+BY+CZ+D=0')"},
  ...
  {F | S, "ColorScheme", opt_general_color_scheme, 1.,
   "Default color scheme for graphics (0: light, 1: default, 2: grayscale, 3: "
   "dark)"},
  ...
  {F | S, "ExtraPositionX", opt_general_extra_position0, 650.,
   "Horizontal position (in pixels) of the upper left corner of the generic "
   "extra window"},
  {F | S, "ExtraPositionY", opt_general_extra_position1, 350.,
   "Vertical position (in pixels) of the upper left corner of the generic "
   "extra window"},
  ...
  {F | S, "FieldPositionX", opt_general_field_position0, 650.,
   "Horizontal position (in pixels) of the upper left corner of the field "
   "window"},
  {F | S, "FieldPositionY", opt_general_field_position1, 550.,
   "Vertical position (in pixels) of the upper left corner of the field "
   "window"},
  ...
  {F | S, "FileChooserPositionX", opt_general_file_chooser_position0, 200.,
   "Horizontal position (in pixels) of the upper left corner of the file "
   "chooser "
   "windows"},
  ...
  {F | O, "InputScrolling", opt_general_input_scrolling, 1.,
   "Enable numerical input scrolling in user interface (moving the mouse to "
   "change "
   "numbers)"},

  {F | O, "Light0", opt_general_light0, 1., "Enable light source 0"},
  {F | O, "Light0X", opt_general_light00, 0.65, "X position of light source 0"},
  {F | O, "Light0Y", opt_general_light01, 0.65, "Y position of light source 0"},
  {F | O, "Light0Z", opt_general_light02, 1.0, "Z position of light source 0"},
  {F | O, "Light0W", opt_general_light03, 0.0,
   "Divisor of the X, Y and Z coordinates of light source 0 (W=0 means "
   "infinitely far source)"},
  {F | O, "Light1", opt_general_light1, 0., "Enable light source 1"},
  {F | O, "Light1X", opt_general_light10, 0.5, "X position of light source 1"},
  {F | O, "Light1Y", opt_general_light11, 0.3, "Y position of light source 1"},
  {F | O, "Light1Z", opt_general_light12, 1.0, "Z position of light source 1"},
  {F | O, "Light1W", opt_general_light13, 0.0,
   "Divisor of the X, Y and Z coordinates of light source 1 (W=0 means "
   "infinitely "
   "far source)"},
  {F | O, "Light2", opt_general_light2, 0., "Enable light source 2"},
  {F | O, "Light2X", opt_general_light20, 0.5, "X position of light source 2"},
  {F | O, "Light2Y", opt_general_light21, 0.3, "Y position of light source 2"},
  {F | O, "Light2Z", opt_general_light22, 1.0, "Z position of light source 2"},
  {F | O, "Light2W", opt_general_light23, 0.0,
   "Divisor of the X, Y and Z coordinates of light source 2 (W=0 means "
   "infinitely "
   "far source)"},
  {F | O, "Light3", opt_general_light3, 0., "Enable light source 3"},
  {F | O, "Light3X", opt_general_light30, 0.5, "X position of light source 3"},
  {F | O, "Light3Y", opt_general_light31, 0.3, "Y position of light source 3"},
  {F | O, "Light3Z", opt_general_light32, 1.0, "Z position of light source 3"},
  {F | O, "Light3W", opt_general_light33, 0.0,
   "Divisor of the X, Y and Z coordinates of light source 3 (W=0 means "
   "infinitely "
   "far source)"},
  {F | O, "Light4", opt_general_light4, 0., "Enable light source 4"},
  {F | O, "Light4X", opt_general_light40, 0.5, "X position of light source 4"},
  {F | O, "Light4Y", opt_general_light41, 0.3, "Y position of light source 4"},
  {F | O, "Light4Z", opt_general_light42, 1.0, "Z position of light source 4"},
  {F | O, "Light4W", opt_general_light43, 0.0,
   "Divisor of the X, Y and Z coordinates of light source 4 (W=0 means "
   "infinitely "
   "far source)"},
  {F | O, "Light5", opt_general_light5, 0., "Enable light source 5"},
  {F | O, "Light5X", opt_general_light50, 0.5, "X position of light source 5"},
  {F | O, "Light5Y", opt_general_light51, 0.3, "Y position of light source 5"},
  {F | O, "Light5Z", opt_general_light52, 1.0, "Z position of light source 5"},
  {F | O, "Light5W", opt_general_light53, 0.0,
   "Divisor of the X, Y and Z coordinates of light source 5 (W=0 means "
   "infinitely "
   "far source)"},
  ...
  {F | S, "ManipulatorPositionX", opt_general_manip_position0, 650.,
   "Horizontal position (in pixels) of the upper left corner of the "
   "manipulator "
   "window"},
  ...
  {F | S, "MessageHeight", opt_general_message_size, 300.,
   "Height (in pixels) of the message console when it is visible (should be > "
   "0)"},
  ...
  {F | S, "OptionsPositionY", opt_general_option_position1, 150.,
   "Vertical position (in pixels) of the upper left corner of the option "
   "window"},
  ...
  {F | S, "PluginPositionY", opt_general_plugin_position1, 550.,
   "Vertical position (in pixels) of the upper left corner of the plugin "
   "window"},
  ...
  {F | O, "PolygonOffsetAlwaysOn", opt_general_polygon_offset_always, 0.,
   "Always apply polygon offset, instead of trying to detect when it is "
   "required"},
  ...
  {F | O, "QuadricSubdivisions", opt_general_quadric_subdivisions, 6.,
   "Number of subdivisions used to draw points or lines as spheres or "
   "cylinders"},
  ...
  {F | S, "SaveSession", opt_general_session_save, 1.,
   ...
   "when the graphical user interface is closed?"},
  {F, "ScaleX", opt_general_scale0, 1.0, "X-axis scale factor"},
  {F, "ScaleY", opt_general_scale1, 1.0, "Y-axis scale factor"},
  {F, "ScaleZ", opt_general_scale2, 1.0, "Z-axis scale factor"},
  {F | O, "Shininess", opt_general_shine, 0.4, "Material shininess"},
  ...
  {F | O, "SmallAxes", opt_general_small_axes, 1., "Display the small axes"},
  ...
  {F | O, "SmallAxesPositionY", opt_general_small_axes_position1, -40.,
   "Y position (in pixels) of small axes (< 0: measure from bottom window "
   "edge; >= 1e5:"
   " centered)"},
  ...
  {F | S, "StatisticsPositionY", opt_general_statistics_position1, 150.,
   ...
   " window"},
  {F | O, "Stereo", opt_general_stereo_mode, 0., "Use stereo rendering"},
  ...
  {F | O, "TrackballHyperbolicSheet", opt_general_trackball_hyperbolic_sheet,
   1., "Use hyperbolic sheet away from trackball center for z-rotations"},
...
StringXNumber GeometryOptions_Number[] = {
  ...
  {F | O, "CopyMeshingMethod", opt_geometry_copy_meshing_method, 0.,
   "Copy meshing method (unstructured or transfinite) when duplicating "
   "geometrical "
   "entities with built-in geometry kernel?"},
  {F | O, "Curves", opt_geometry_curves, 1., "Display geometry curves?"},
  {F | O, "CurveLabels", opt_geometry_curve_labels, 0.,
   "Display curve labels?"},
  {F | O | D, "CurveNumbers", opt_geometry_curve_labels, 0., "[Deprecated]"},
  ...
  {F | O, "ExtrudeReturnLateralEntities", opt_geometry_extrude_return_lateral,
   1., "Add lateral entities in lists returned by extrusion commands?"},
  ...
  {F | O, "LabelType", opt_geometry_label_type, 0.,
   ...
   "5: coordinates)"},
  {F | O, "Light", opt_geometry_light, 1., "Enable lighting for the geometry"},
  {F | O, "LightTwoSide", opt_geometry_light_two_side, 1.,
   "Light both sides of surfaces (leads to slower rendering)"},
  {F | O | D, "Lines", opt_geometry_curves, 1., "[Deprecated]"},
  {F | O | D, "LineNumbers", opt_geometry_curve_labels, 0., "[Deprecated]"},
  {F | O | D, "LineSelectWidth", opt_geometry_curve_sel_width, 3.,
   "[Deprecated]"},
  {F | O | D, "LineType", opt_geometry_curve_type, 0., "[Deprecated]"},
  {F | O | D, "LineWidth", opt_geometry_curve_width, 2., "[Deprecated]"},
  ...
  {F | O, "OCCAutoEmbed", opt_geometry_occ_auto_embed, 1.,
   "Automatically embed points, curves and faces in higher dimensional "
   "entities if "
   "they are marked as 'internal' by OpenCASCADE"},
  {F | O, "OCCAutoFix", opt_geometry_occ_auto_fix, 1.,
   "Automatically fix orientation of wires, faces, shells and volumes when "
   "creating "
   "new entities with the OpenCASCADE kernel"},
  {F | O, "OCCBooleanCheckInverted", opt_geometry_occ_boolean_check_inverted,
   1., "Check input solid in boolean operations for inverted status?"},
  {F | O, "OCCBooleanGlue", opt_geometry_occ_boolean_glue, 0.,
   ...
   "shapes that do overlap but do not have real intersections (0: off, 1: "
   "allow "
   "shapes with partial overlaps, 2: only allow shapes with full coincidence)"},
  {F | O, "OCCBooleanNonDestructive", opt_geometry_occ_boolean_non_destructive,
   0., "Do not modify the argument shapes during boolean operations?"},
  {F | O, "OCCBooleanPreserveNumbering",
   opt_geometry_occ_boolean_preserve_numbering, 1.,
   "Try to preserve the numbering of entities through OpenCASCADE boolean "
   "operations"},
  ...
  {F | O, "OCCMakeSolids", opt_geometry_occ_make_solids, 0.,
   "Fix shells and make solids when importing STEP, IGES and BREP models with "
   "the "
   "OpenCASCADE kernel"},
  ...
  {F | O, "OCCFastUnbind", opt_geometry_occ_fast_unbind, 1.,
   "Use fast (i.e. without recursive checks on boundaries) unbinding of "
   "entities "
  ...
  {F | O | D, "OCCUnionUnify", opt_geometry_occ_boolean_simplify, 1.,
   "[Deprecated]"},
  {F | O, "OCCUseGenericClosestPoint",
   opt_geometry_occ_use_generic_closest_point, 0.,
   "Use generic algrithm to compute point projections in the OpenCASCADE "
   "kernel "
  ...
  {F | O, "OldRuledSurface", opt_geometry_old_ruled_surface, 0.,
   "Use old 3-sided ruled surface interpolation (compatibility option for old "
   "Gmsh geometries)"},
  ...
  {F | O, "OrientedPhysicals", opt_geometry_oriented_physicals, 1.,
   "Use sign of elementary entity in physical definition as orientation "
   "indicator"},

  {F | O, "Points", opt_geometry_points, 1., "Display geometry points?"},
  {F | O, "PointLabels", opt_geometry_point_labels, 0.,
   "Display points labels?"},
  {F | O | D, "PointNumbers", opt_geometry_point_labels, 0., "[Deprecated]"},
  ...
  {F | O, "ReparamOnFaceRobust", opt_geometry_reparam_on_face_robust, 0,
   "Use projection for reparametrization of a point classified on GEdge on a "
   "GFace"},

  {F | O, "ScalingFactor", opt_geometry_scaling_factor, 1.0,
   "Global geometry scaling factor"},
  {F | O, "SnapPoints", opt_geometry_snap_points, 1.,
   "Snap points on curves if their evaluation using the parametrization is "
   "larger "
   "than the geometrical tolerance (currently only with the OpenCASCADE "
   "kernel)"},
  ...
  {F | O, "Surfaces", opt_geometry_surfaces, 0., "Display geometry surfaces?"},
  ...
  {F | O, "SurfaceType", opt_geometry_surface_type, 0.,
   "Surface display type (0: cross, 1: wireframe, 2: solid). Wireframe and "
   "solid "
   "are not available with the built-in geometry kernel."},

  {F | O, "Tangents", opt_geometry_tangents, 0.,
   "Display size of tangent vectors (in pixels)"},
  {F | O, "Tolerance", opt_geometry_tolerance, 1.e-8, "Geometrical tolerance"},
  ...
  {F | O, "Volumes", opt_geometry_volumes, 0., "Display geometry volumes?"},
  {F | O, "VolumeLabels", opt_geometry_volume_labels, 0.,
   "Display volume labels?"},
  {F | O | D, "VolumeNumbers", opt_geometry_volume_labels, 0., "[Deprecated]"},
...
StringXNumber MeshOptions_Number[] = {
  ...
  {F | O, "AngleToleranceFacetOverlap", opt_mesh_angle_tolerance_facet_overlap,
   0.1,
   "Consider connected facets as overlapping when the dihedral angle between "
   "the facets is "
  ...
  {F | O, "AvgQuality", opt_mesh_avg_quality, 0.,
   "Average mesh quality (inverse conditioning number, ICN) after the "
   "generation "
  ...
  {F | O | D, "BoundaryLayerFanPoints", opt_mesh_boundary_layer_fan_elements,
   5., "[Deprecated]"},
  ...
  {F | O | D, "CharacteristicLengthExtendFromBoundary",
   opt_mesh_lc_extend_from_boundary, 1., "[Deprecated]"},
  {F | O | D, "CharacteristicLengthFactor", opt_mesh_lc_factor, 1.0,
   "[Deprecated]"},
  {F | O | D, "CharacteristicLengthMin", opt_mesh_lc_min, 0.0, "[Deprecated]"},
  {F | O | D, "CharacteristicLengthMax", opt_mesh_lc_max, 1.e22,
   "[Deprecated]"},
  {F | O | D, "CharacteristicLengthFromCurvature", opt_mesh_lc_from_curvature,
   0., "[Deprecated]"},
  {F | O | D, "CharacteristicLengthFromPoints", opt_mesh_lc_from_points, 1.,
   "[Deprecated]"},
  {F | O | D, "CharacteristicLengthFromParametricPoints",
   opt_mesh_lc_from_parametric_points, 0., "[Deprecated]"},
  {F | O, "CheckSurfaceNormalValidity", opt_mesh_check_surface_normal_validity,
   1., "Check surface mesh validity according to the geometry normal"},
  ...
  {F | O, "CompoundClassify", opt_mesh_compound_classify, 1.,
   "How are surface mesh elements classified on compounds? (0: on the new "
   "discrete "
   "surface, 1: on the original geometrical surfaces - incompatible with e.g. "
   "high-order "
   "meshing)"},
  {F | O | D, "CompoundCharacteristicLengthFactor", opt_mesh_compound_lc_factor,
   0.5, "[Deprecated]"},
  ...
  {F | O, "FlexibleTransfinite", opt_mesh_flexible_transfinite, 0,
   "Allow transfinite constraints to be modified for recombination (e.g. "
   "Blossom) or "
  ...
  {F | O, "Format", opt_mesh_file_format, FORMAT_AUTO,
   ...
   "26: pos stat, 27: stl, 28: p3d, 30: mesh, 31: bdf, 32: cgns, 33: med, 34: "
   "diff, "
   "38: ir3, 39: inp, 40: ply2, 41: celum, 42: su2, 47: tochnog, 49: neu, 50: "
   "matlab)"},
  {F | O, "Hexahedra", opt_mesh_hexahedra, 1., "Display mesh hexahedra?"},
  ...
  {F | O, "HighOrderFixBoundaryNodes", opt_mesh_ho_fix_bnd_nodes, 0,
   "Fix all (1) or periodic (2) boundary nodes during high-order "
   "optimization?"},
  ...
  {F | O, "HighOrderOptimize", opt_mesh_ho_optimize, 0.,
   "Optimize high-order meshes? (0: none, 1: optimization, 2: "
  ...
  {F | O, "HighOrderPeriodic", opt_mesh_ho_periodic, 0.,
   "Force location of nodes for periodic meshes using periodicity transform "
   "(0: "
   "assume identical parametrisations, 1: invert parametrisations, 2: compute "
   "closest point"},
  {F | O, "HighOrderPoissonRatio", opt_mesh_ho_poisson, 0.33,
   "Poisson ratio of the material used in the elastic smoother for high-order "
   "meshes "
  ...
  {F | O, "HighOrderMaxInnerAngle", opt_mesh_ho_max_in_angle,
   3.1415927 * 30. / 180.,
  ...
  {F | O, "IgnoreUnknownSections", opt_mesh_ignore_unknown_sections, 0.,
   "Skip unknown sections when reading meshes in the MSH4 format (otherwise "
   "the "
  ...
  {F | O, "Light", opt_mesh_light, 1., "Enable lighting for the mesh"},
  ...
  {F | O, "LightTwoSide", opt_mesh_light_two_side, 1.,
   "Light both sides of surfaces (leads to slower rendering)"},
  {F | O, "Lines", opt_mesh_lines, 0., "Display mesh lines (1D elements)?"},
  {F | O, "LineLabels", opt_mesh_line_labels, 0., "Display mesh line labels?"},
  {F | O | D, "LineNumbers", opt_mesh_line_labels, 0., "[Deprecated]"},
  {F | O, "LineWidth", opt_mesh_line_width, 1.0,
   "Display width of mesh lines (in pixels)"},

  {F | O, "MaxFlatAreaChange", opt_mesh_max_flat_area_change, 1e100,
   "Maximum intrinsic angle during geodesic remeshing "},
  {F | O, "MaxIntrinsicAngle", opt_mesh_max_intrinsic_angle, 1e100,
   "Maximum intrinsic angle during geodesic remeshing "},
  {F | O, "MaxIntrinsicEdgeStretch", opt_mesh_max_intrinsic_edge_stretch, 1e100,
   "Maximum ratio of the intrinsic edge length to the straight-line distance "
  ...
  {F | O, "MeshSizeExtendFromBoundary", opt_mesh_lc_extend_from_boundary, 1.,
   ...
   "interior "
   "(0: never; 1: for surfaces and volumes; 2: for surfaces and volumes, but "
   "use "
   "smallest surface element edge length instead of longest length in 3D "
   "Delaunay; "
   "-2: only for surfaces; -3: only for volumes)"},
  {F | O, "MeshSizeFactor", opt_mesh_lc_factor, 1.0,
   "Factor applied to all mesh element sizes"},
  {F | O, "MeshSizeMin", opt_mesh_lc_min, 0.0, "Minimum mesh element size"},
  {F | O, "MeshSizeMax", opt_mesh_lc_max, 1.e22, "Maximum mesh element size"},
  ...
  {F | O, "MeshSizeFromParametricPoints", opt_mesh_lc_from_parametric_points,
   0.,
  ...
  {F | O, "MetisMaxLoadImbalance", opt_mesh_partition_metis_max_load_imbalance,
   -1.,
   "METIS maximum load imbalance 'ufactor' (-1: default, i.e. 30 for K-way and "
   "1 "
   "for Recursive)"},
  {F | O, "MetisObjective", opt_mesh_partition_metis_objective, 1.,
   "METIS objective type 'objtype' (1: min. edge-cut, 2: min. communication "
   "volume)"},
  {F | O, "MetisMinConn", opt_mesh_partition_metis_min_conn, -1.,
   "METIS minimize maximum connectivity of partitions 'minconn' (-1: default)"},
  {F | O, "MetisRefinementAlgorithm",
   opt_mesh_partition_metis_refinement_algorithm, 2.,
  ...
  {F | O, "MinQuality", opt_mesh_min_quality, 0.,
   ...
   "generation "
   "of the current mesh (read-only)"},
  {F | O | D, "MinimumLineNodes", opt_mesh_min_line_nodes, 2., "[Deprecated]"},
  ...
  {F | O, "MedFileMinorVersion", opt_mesh_med_file_minor_version, -1.,
   "Minor version of the MED file format to use (-1: use minor version of the "
   "MED library)"},
  {F | O, "MedImportGroupsOfNodes", opt_mesh_med_import_groups_of_nodes, 0.,
   "Import groups of nodes (0: no; 1: create geometrical point for each "
   "node)?"},
  {F | O, "MedSingleModel", opt_mesh_med_single_model, 0.,
   "Import MED meshes in the current model, even if several MED mesh names "
   "exist"},
  ...
  {F | O, "NbPartitions", opt_mesh_partition_num, 0., "Number of partitions"},
  ...
  {F | O, "NewtonConvergenceTestXYZ", opt_mesh_newton_convergence_test_xyz, 0.,
   "Force inverse surface mapping algorithm (Newton-Raphson) to converge in "
   "real "
   "coordinates (experimental)"},
  {F | O, "Nodes", opt_mesh_nodes, 0., "Display mesh nodes?"},
  {F | O, "NodeLabels", opt_mesh_node_labels, 0., "Display mesh node labels?"},
  ...
  {F | O, "PartitionPrismWeight", opt_mesh_partition_pri_weight, -1,
   "Weight of prismatic element (wedge) for METIS load balancing (-1: "
   "automatic)"},
  ...
  {F | O, "PartitionCreateGhostCells", opt_mesh_partition_create_ghost_cells, 0,
   "Create ghost cells, i.e. create for each partition a ghost entity "
   "containing "
  ...
  {F | O, "PartitionSplitLocalBrep", opt_mesh_partition_split_local_brep, 0.,
   "Only export the subset of the topology (BRep) that is relevant when "
   "splitting mesh files per partition"},
  ...
  {F | O, "PartitionConvertMsh2", opt_mesh_partition_convert_msh2, 1,
   ...
   "entities"},
  {F | O | D, "Points", opt_mesh_nodes, 0., "[Deprecated]"},
  {F | O | D, "PointNumbers", opt_mesh_node_labels, 0., "[Deprecated]"},
  {F | O | D, "PointSize", opt_mesh_node_size, 4., "[Deprecated]"},
  {F | O | D, "PointType", opt_mesh_node_type, 0., "[Deprecated]"},
  {F | O, "PreserveNumberingMsh2", opt_mesh_preserve_numbering_msh2, 0.,
   "Preserve node and element numbering in MSH2 format (will break meshes with "
   "multiple "
   "physical groups for a single elementary entity)"},
  {F | O, "Prisms", opt_mesh_prisms, 1., "Display mesh prisms?"},
  {F | O, "Pyramids", opt_mesh_pyramids, 1., "Display mesh pyramids?"},
  ...
  {F | O, "QuadqsSizemapMethod", opt_mesh_quadqs_sizemap_method, 3,
   ...
   "4: cross-field + CAD small features adaptation (clamped by background "
   "mesh)"},
  {F | O, "QuadqsTopologyOptimizationMethods",
   opt_mesh_quadqs_topo_optim_methods, 0.,
  ...
  {F | O, "QuadqsScalingOnTriangulation",
   opt_mesh_quadqs_scaling_on_triangulation, 0.75,
  ...
  {F | O, "Quadrangles", opt_mesh_quadrangles, 1., "Display mesh quadrangles?"},
  ...
  {F | O, "QuasiTransfinite", opt_mesh_quasi_transfinite, 0,
   "Allow quasi-transfinite meshing of surfaces with non-matching number of "
   "nodes on "
   "opposite sides"},
  ...
  {F | O, "RecombineNodeRepositioning", opt_mesh_recombine_node_repositioning,
   1, "Allow repositioning of nodes during recombination of surface meshes"},
  ...
  {F | O, "Renumber", opt_mesh_renumber, 1,
   "Renumber nodes and elements in a continuous sequence after mesh "
   "generation"},
  ...
  {F | O, "SaveGroupsOfElements", opt_mesh_save_groups_of_elements, 1.,
   "Save groups of elements for each physical group (for UNV and INP mesh "
   "format) "
  ...
  {F | O, "SaveWithoutOrphans", opt_mesh_save_without_orphans, 0.,
   "Don't save orphan entities (not connected to any highest dimensional "
   "entity "
   "in the model) in MSH4 files"},
  {F | O, "SaveTopology", opt_mesh_save_topology, 0.,
   "Save model topology in MSH2 output files (this is always saved in MSH3 and "
   "above)"},
  {F | O, "ScalingFactor", opt_mesh_scaling_factor, 1.0,
   "Global scaling factor applied to the saved mesh"},
  {F | O, "SecondOrderIncomplete", opt_mesh_second_order_incomplete, 0.,
   "Create incomplete second order elements? (8-node quads, 20-node hexas, "
   "etc.)"},
  {F | O, "SecondOrderLinear", opt_mesh_second_order_linear, 0.,
   "Should second order nodes (as well as nodes generated with subdivision "
   "algorithms) "
  ...
  {F | O, "StlLinearDeflection", opt_mesh_stl_linear_deflection, 0.001,
   "Maximum relative linear deflection when creating STL representation of "
   "entities "
   "(currently only used with the OpenCASCADE kernel)"},
  {F | O, "StlLinearDeflectionRelative",
   opt_mesh_stl_linear_deflection_relative, 1,
   "Compute the linear deflection for STL representations relative to the "
   "length "
  ...
  {F | O, "StlRemoveBadTriangles", opt_mesh_stl_remove_bad_triangles, 0.,
   "Remove bad triangles when importing STL files (1: remove duplicates; 2: "
   "remove "
   "duplicate and zero-area triangles)"},
  {F | O | D, "StlRemoveDuplicateTriangles", opt_mesh_stl_remove_bad_triangles,
   0., "[Deprecated]"},
  ...
  {F | O | D, "SurfaceNumbers", opt_mesh_surface_labels, 0., "[Deprecated]"},
  ...
  {F | O, "Tangents", opt_mesh_tangents, 0.0,
   "Display size of tangent vectors (in pixels)"},
  {F | O, "Tetrahedra", opt_mesh_tetrahedra, 1., "Display mesh tetrahedra?"},
  {F | O, "ToleranceEdgeLength", opt_mesh_tolerance_edge_length, 0.0,
   ...
   "defined tolerance"},
  {F | O, "ToleranceInitialDelaunay", opt_mesh_tolerance_initial_delaunay,
   1.e-12, "Tolerance for initial 3D Delaunay mesher"},
  {F | O, "ToleranceReferenceElement", opt_mesh_tolerance_reference_element,
   1e-6,
   "Tolerance for classifying a point inside a reference element (of size 1)"},
  {F | O, "Triangles", opt_mesh_triangles, 1., "Display mesh triangles?"},
  {F | O, "Trihedra", opt_mesh_trihedra, 1., "Display mesh trihedra?"},
  ...
  {F | O | D, "VolumeNumbers", opt_mesh_volume_labels, 0., "[Deprecated]"},
  {F | O, "Voronoi", opt_mesh_voronoi, 0., "Display the voronoi diagram"},

  {F | O, "ZoneDefinition", opt_mesh_zone_definition, 0.,
   "Method for defining a zone (0: single zone, 1: by partition, 2: by "
   "physical)"},
...
StringXNumber SolverOptions_Number[] = {
  ...
  {F | O, "Plugins", opt_solver_plugins, 0., "Enable default solver plugins?"},
...
StringXNumber PostProcessingOptions_Number[] = {
  ...
  {F | O, "Format", opt_post_file_format, 10.,
   ...
   "view, 2: parsed view, 3: STL triangulation, 4: raw text, 5: Gmsh mesh, 6: "
   "MED file, "
   "10: automatic)"},
  ...
  {F | O, "Link", opt_post_link, 0.,
   "Post-processing view links (0: apply next option changes to selected "
   "views, "
...
StringXNumber ViewOptions_Number[] = {
  ...
  {F | O, "AutoPosition", opt_view_auto_position, 1.,
   "Position the scale or 2D plot automatically (0: manual, 1: automatic, 2: "
   "top left, "
   "3: top right, 4: bottom left, 5: bottom right, 6: top, 7: bottom, 8: left, "
   "9: right, "
   "10: full, 11: top third, 12: in model coordinates)"},
  {F | O, "Axes", opt_view_axes, 0,
   "Axes (0: none, 1: simple axes, 2: box, 3: full grid, 4: open grid, 5: "
   "ruler)"},
  {F | O, "AxesMikado", opt_view_axes_mikado, 0., "Mikado axes style"},
  {F | O, "AxesAutoPosition", opt_view_axes_auto_position, 1.,
   "Position the axes automatically"},
  {F | O, "AxesMaxX", opt_view_axes_xmax, 1., "Maximum X-axis coordinate"},
  {F | O, "AxesMaxY", opt_view_axes_ymax, 1., "Maximum Y-axis coordinate"},
  {F | O, "AxesMaxZ", opt_view_axes_zmax, 1., "Maximum Z-axis coordinate"},
  {F | O, "AxesMinX", opt_view_axes_xmin, 0., "Minimum X-axis coordinate"},
  {F | O, "AxesMinY", opt_view_axes_ymin, 0., "Minimum Y-axis coordinate"},
  {F | O, "AxesMinZ", opt_view_axes_zmin, 0., "Minimum Z-axis coordinate"},
  {F | O, "AxesTicsX", opt_view_axes_tics0, 5., "Number of tics on the X-axis"},
  {F | O, "AxesTicsY", opt_view_axes_tics1, 5., "Number of tics on the Y-axis"},
  {F | O, "AxesTicsZ", opt_view_axes_tics2, 5., "Number of tics on the Z-axis"},
  ...
  {F | O, "ColormapBias", opt_view_colormap_bias, 0.0, "Colormap bias"},
  ...
  {F | O, "DrawScalars", opt_view_draw_scalars, 1., "Display scalar values?"},
  ...
  {F | O, "DrawTensors", opt_view_draw_tensors, 1., "Display tensor values?"},
  ...
  {F | O, "DrawVectors", opt_view_draw_vectors, 1., "Display vector values?"},
  ...
  {F | O, "ForceNumComponents", opt_view_force_num_components, 0.,
   "Force number of components to display (see View.ComponentMapN for "
   "mapping)"},
  ...
  {F | O, "Light", opt_view_light, 1., "Enable lighting for the view"},
  {F | O, "LightLines", opt_view_light_lines, 1., "Light element edges"},
  ...
  {F, "Max", opt_view_max, 0., "Maximum value in the view (read-only)"},
  ...
  {F, "Min", opt_view_min, 0., "Minimum value in the view (read-only)"},
  ...
  {F | O, "NbIso", opt_view_nb_iso, 10., "Number of intervals"},
  ...
  {F | O, "ShowElement", opt_view_show_element, 0., "Show element boundaries?"},
  {F | O, "ShowScale", opt_view_show_scale, 1., "Show value scale?"},
  {F | O, "ShowTime", opt_view_show_time, 3.,
   "Time display mode (0: none, 1: time series, 2: harmonic data, 3: "
   "automatic, "
   "4: step data, 5: multi-step data, 6: real eigenvalues, 7: complex "
   "eigenvalues)"},
  {F | O, "SmoothNormals", opt_view_smooth_normals, 0., "Smooth the normals?"},
  ...
  {F | O, "TensorType", opt_view_tensor_type, 1.,
   "Tensor display type (1: Von-Mises, 2: maximum eigenvalue, 3: minimum "
   "eigenvalue, "
   "4: eigenvectors, 5: ellipse, 6: ellipsoid, 7: frame (box), 8: frame "
   "(vectors))"},
  {F, "TimeStep", opt_view_timestep, 0., "Current time step displayed"},
  ...
  {F, "Visible", opt_view_visible, 1., "Is the view visible?"},
...
StringXNumber PrintOptions_Number[] = {
  ...
  {F | O, "CompositeWindows", opt_print_composite_windows, 0.,
   "Composite all window tiles in the same output image (for bitmap output "
   "only)"},
  ...
  {F | O, "EpsBestRoot", opt_print_eps_best_root, 1.,
   "Try to minimize primitive splitting in BSP tree sorted PostScript/PDF "
   "output"},
  ...
  {F | O, "GifInterlace", opt_print_gif_interlace, 0., "Interlace GIF output"},
  {F | O, "GifSort", opt_print_gif_sort, 1., "Sort the colormap in GIF output"},
  ...
  {F | O, "PgfTwoDim", opt_print_pgf_two_dim, 1.,
   "Output PGF format for two dimensions. Mostly irrelevant if "
   "`PgfExportAxis=0`. "
   "Default `1` (yes)."},
  ...
  {F | O, "Text", opt_print_text, 1., "Print text strings?"},
...
StringXColor GeneralOptions_Color[] = {{F | O,
                                        "Background",
...
StringXColor GeometryOptions_Color[] = {{F | O,
                                         "Points",
...
StringXColor MeshOptions_Color[] = {
  ...
  {F | O,
   ...
   {0, 0, 0, 255},
   "Mesh line color"},
  {F | O, "Triangles", opt_mesh_color_triangles, COLT, COLT, COLW, COLT,
   "Mesh triangle color (if Mesh.ColorCarousel=0)"},
  {F | O, "Quadrangles", opt_mesh_color_quadrangles, COLQ, COLQ, COLW, COLQ,
   "Mesh quadrangle color (if Mesh.ColorCarousel=0)"},
  {F | O, "Tetrahedra", opt_mesh_color_tetrahedra, COLT, COLT, COLW, COLT,
   "Mesh tetrahedron color (if Mesh.ColorCarousel=0)"},
  {F | O, "Hexahedra", opt_mesh_color_hexahedra, COLQ, COLQ, COLW, COLQ,
   "Mesh hexahedron color (if Mesh.ColorCarousel=0)"},
  {F | O, "Prisms", opt_mesh_color_prisms, COLP, COLP, COLW, COLP,
  ...
  {F | O, "Trihedra", opt_mesh_color_trihedron, COLR, COLR, COLW, COLR,
...
StringXColor SolverOptions_Color[] = {{0,
                                       nullptr,
                                       nullptr,
                                       {0, 0, 0, 0},
                                       {0, 0, 0, 0},
...
StringXColor PostProcessingOptions_Color[] = {{0,
                                               nullptr,
                                               nullptr,
                                               {0, 0, 0, 0},
                                               {0, 0, 0, 0},
...
StringXColor ViewOptions_Color[] = {
  ...
  {F | O, "Quadrangles", opt_view_color_quadrangles, ELECOL,
   "Quadrangle color"},
...
StringXColor PrintOptions_Color[] = {{0,
                                      nullptr,
                                      nullptr,
                                      {0, 0, 0, 0},
                                      {0, 0, 0, 0},
...
// // FUNCTION POINTERS
//
// StringXFunctionPointer GeneralOptions_FunctionPointer[] = {
//   {0, nullptr, nullptr, nullptr, nullptr}};
//
// StringXFunctionPointer GeometryOptions_FunctionPointer[] = {
//   {0, nullptr, nullptr, nullptr, nullptr}};
//
// StringXFunctionPointer MeshOptions_FunctionPointer[] = {
//   {0, "Intrinsic edge quality function", opt_mesh_intrinsic_edge_quality,
//    (void (*)())&edgeQuality, nullptr},
//   {0, "Intrinsic triangle quality function",
//    opt_mesh_intrinsic_triangle_quality, nullptr, nullptr},
//   {0, nullptr, nullptr, nullptr, nullptr}};
//
// StringXFunctionPointer SolverOptions_FunctionPointer[] = {
//   {0, nullptr, nullptr, nullptr, nullptr}};
//
// StringXFunctionPointer PostProcessingOptions_FunctionPointer[] = {
//   {0, nullptr, nullptr, nullptr, nullptr}};
//
// StringXFunctionPointer ViewOptions_FunctionPointer[] = {
//   {0, nullptr, nullptr, nullptr, nullptr}};
//
// StringXFunctionPointer PrintOptions_FunctionPointer[] = {
//   {0, nullptr, nullptr, nullptr, nullptr}};
