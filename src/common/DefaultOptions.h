...
StringXNumber GeneralOptions_Number[] = {
  ...
  { F|O, "AxesTicksX" , opt_general_axes_tics0 , 5. ,
    "Number of ticks on the X-axis (about that many, when the labels "
    "are placed at round values)" },
  { F|O, "AxesTicksY" , opt_general_axes_tics1 , 5. ,
    "Number of ticks on the Y-axis (about that many, when the labels "
    "are placed at round values)" },
  { F|O, "AxesTicksZ" , opt_general_axes_tics2 , 5. ,
    "Number of ticks on the Z-axis (about that many, when the labels "
    "are placed at round values)" },
  { F|O|D, "AxesTicsX" , opt_general_axes_tics0 , 5. ,
    "[Deprecated]" },
  { F|O|D, "AxesTicsY" , opt_general_axes_tics1 , 5. ,
    "[Deprecated]" },
  { F|O|D, "AxesTicsZ" , opt_general_axes_tics2 , 5. ,
    "[Deprecated]" },
...
StringXNumber ViewOptions_Number[] = {
  ...
  { F|O, "AxesMinZ" , opt_view_axes_zmin , 0. ,
    "Minimum Z-axis coordinate" },
  { F|O, "AxesTicksX" , opt_view_axes_tics0 , 5. ,
    "Number of ticks on the X-axis (about that many, when the labels "
    "are placed at round values)" },
  { F|O, "AxesTicksY" , opt_view_axes_tics1 , 5. ,
    "Number of ticks on the Y-axis (about that many, when the labels "
    "are placed at round values)" },
  { F|O, "AxesTicksZ" , opt_view_axes_tics2 , 5. ,
    "Number of ticks on the Z-axis (about that many, when the labels "
    "are placed at round values)" },
  { F|O|D, "AxesTicsX" , opt_view_axes_tics0 , 5. ,
    "[Deprecated]" },
  { F|O|D, "AxesTicsY" , opt_view_axes_tics1 , 5. ,
    "[Deprecated]" },
  { F|O|D, "AxesTicsZ" , opt_view_axes_tics2 , 5. ,
    "[Deprecated]" },
