...
StringXNumber MeshOptions_Number[] = {
  ...
  { F|O, "QuadqsFinalSplitCadDistanceRatio", opt_mesh_quadqs_final_split_cad_distance_ratio, 0.2,
  ...
  { F|O, "QuadqsPacking3D" , opt_mesh_quadqs_packing_3d, 0 ,
    "Use tangent-frame propagation and oriented exclusion cubes in 3D for "
      ...
      "cubes)" },
  { F|O, "QuadqsPacking3DForceAllPoints" ,
    opt_mesh_quadqs_packing_3d_force_all_points, 0 ,
    "Force every point generated by 3D packing into the surface "
      "triangulation and report an error if any insertion still fails" },
