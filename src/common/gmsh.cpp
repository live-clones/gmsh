                                          ...
                                          GModel *const model)
{
  ...
  using PartitionEntity = typename OverlapHelpers<dim>::PartitionEntity;
                               ...
                               GModel *const model)
{
  ...
  for(OverlapEntity *oe : allOverlaps) {
    ...
    if(oe->getCovered()->getParentEntity()->tag() == tag &&
                                   ...
                                   GModel *const model)
{
  ...
  using BoundaryEntity = typename OverlapHelpers<dim - 1>::Entity;
