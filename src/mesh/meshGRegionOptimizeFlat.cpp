...
// Flat-array kernel that improves the tetrahedra of a region by local mesh
// modifications, selected with Mesh.FlatOptimize3D. Same operations, and
// meshes of the same quality, as the MTet4 kernel in meshGRegionOptimize.cpp,
...
// Flat port of optimizeMesh() (meshGRegionOptimize.cpp): the mesh is
