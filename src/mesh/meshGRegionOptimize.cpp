...
// kernels do the same work: the original one, on the MTet4 objects, and the
// flat one, on index-based arrays, which is the default (Mesh.FlatOptimize3D)
// and is the one meant to remain.
