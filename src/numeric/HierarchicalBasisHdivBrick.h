...
#ifndef HIERARCHICAL_BASIS_HDIV_BRICK_H
#define HIERARCHICAL_BASIS_HDIV_BRICK_H
 ...
 */
class HierarchicalBasisHdivBrick : public HierarchicalBasisHdiv {
public:
  HierarchicalBasisHdivBrick(int order);
  virtual ~HierarchicalBasisHdivBrick();
