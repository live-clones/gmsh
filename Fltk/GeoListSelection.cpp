...
#endif
/*
 A GUI approche to perform selections from a List-Tree of Geometries
 Actions requiring selection of Points, Curves, Faces, and volumes. 
 This may be done from the Gui instead of the Kyeboard. The selection follows
 the same approache as for the keyboard.
 ::: A Gui will appear when needing to select an Entity. :::
 Contributed by Samy Mukadi, September 6/2019
*/
namespace GeoListSelection { 
	...
	void createSelectionWindow ( GModel* model, int type ) {
		...
		//
		{
			...
			treeLeft->item_draw_mode ( FL_TREE_ITEM_DRAW_LABEL_AND_WIDGET | FL_TREE_ITEM_HEIGHT_FROM_WIDGET );
