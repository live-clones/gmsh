...
double HierarchicalBasisHcurlQuad::_affineCoordinate(int const &j, double const &u,
                                                  double const &v)
{
  switch(j) {
...
void HierarchicalBasisHcurlQuad::generateBasis(double const &u, double const &v, double const &w,
                          ...
                          std::vector<std::vector<double>> &bubbleBasis)
{
  ...
  legendreVector[0]=std::vector<double> (std::max(std::max(_pOrderEdge[0]+1,_pOrderEdge[2]+1),_pf1+1));
  legendreVector[1]=std::vector<double> (std::max(std::max(_pOrderEdge[1]+1,_pOrderEdge[3]+1),_pf2+1));
