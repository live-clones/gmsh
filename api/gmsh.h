...
namespace gmsh { // Top-level functions
  ...
  namespace model { // Model functions
    ...
    namespace mesh { // Mesh functions
      ...
      // returned. If `includeInnerModelBoundaries' is set, also return the
      // boundary entities that coincide with an internal boundary of the (non-
      // partitioned) model, i.e. that are shared by two or more non-partitioned
      // entities.
      GMSH_API void getOverlapBoundary(const int dim,
                                       const int tag,
                                       const int partition,
                                       std::vector<int> & entityTags,
                                       const bool includeInnerModelBoundaries = false);
