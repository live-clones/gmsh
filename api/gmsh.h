...
namespace gmsh { // Top-level functions
  ...
  namespace model { // Per-model functions
    ...
    namespace mesh { // Per-model meshing functions
      ...
      // function space data for all entities of dimension `dim'. If `dim' and
      // `tag' are negative, get all function space data in the mesh.
      GMSH_API void getFunctionSpaceData(const int elementType,
                                         const std::string & integrationType,
      ...
      // Get barycenter of element with tag 'elementTag'. If 'primary' is true,
      // only the primary nodes is taking into account and if 'fast' is true the
