...
namespace gmsh { // Top-level functions
  ...
  namespace model { // Per-model functions
    ...
    namespace mesh { // Per-model meshing functions
      ...
      // function. `numBasisFunctions' returns the number nBF of basis functions
      // per element. `basisFunctions' returns the value of the basis functions at
      // the integration points for each element: [e1g1f1,..., e1g1f(C*nBF),
