...
# This file defines the Gmsh Julia API (v4.15.0).
#
...
const GMSH_API_VERSION = "4.15.0"
const GMSH_API_VERSION_MAJOR = 4
const GMSH_API_VERSION_MINOR = 15
const GMSH_API_VERSION_PATCH = 0
const libdir = dirname(@__FILE__)
const libname = Sys.iswindows() ? "gmsh-4.15.dll" : "libgmsh"
import Libdl
