...
class model:
    ...
    def addPhysicalGroup(dim,tags,tag):
        ...
        return int
        """
        api_tags_, apitags_n_ = _ivectorint(tags)
        ierr = c_int()
        api__result__ = lib.gmshModelAddPhysicalGroup(
            c_int(dim),
            api_tags_, apitags_n_,
            c_int(tag),
            byref(ierr))
        if ierr.value != 0 :
            raise ValueError(
    ...
    @staticmethod
    def getBoundary(dimTags,combined,oriented,recursive):
        """
    ...
    @staticmethod
    def getEntitiesInBoundingBox(xmin,ymin,zmin,xmax,ymax,zmax,dim):
        """
    ...
    @staticmethod
    def addDiscreteEntity(dim,tag,boundary):
        """
        ...
        return int
        """
        api_boundary_, apiboundary_n_ = _ivectorint(boundary)
        ierr = c_int()
        api__result__ = lib.gmshModelAddDiscreteEntity(
            c_int(dim),
            c_int(tag),
            api_boundary_, apiboundary_n_,
            byref(ierr))
        if ierr.value != 0 :
            raise ValueError(
    ...
    @staticmethod
    def removeEntities(dimTags,recursive):
        """
    ...
    class mesh:
        ...
        def setVertices(dim,tag,vertexTags,coord,parametricCoord):
            ...
            """
            api_vertexTags_, apivertexTags_n_ = _ivectorint(vertexTags)
            api_coord_, apicoord_n_ = _ivectordouble(coord)
            api_parametricCoord_, apiparametricCoord_n_ = _ivectordouble(parametricCoord)
            ierr = c_int()
            lib.gmshModelMeshSetVertices(
                c_int(dim),
                c_int(tag),
                api_vertexTags_, apivertexTags_n_,
                api_coord_, apicoord_n_,
                api_parametricCoord_, apiparametricCoord_n_,
                byref(ierr))
            if ierr.value != 0 :
                raise ValueError(
        ...
        def setElements(dim,tag,types,elementTags,vertexTags):
            ...
            """
            api_types_, apitypes_n_ = _ivectorint(types)
        ...
        @staticmethod
        def setTransfiniteLine(tag,numVertices,type,coef):
            """
        ...
        @staticmethod
        def setTransfiniteSurface(tag,arrangement,cornerTags):
            """
            ...
            """
            api_cornerTags_, apicornerTags_n_ = _ivectorint(cornerTags)
            ierr = c_int()
            lib.gmshModelMeshSetTransfiniteSurface(
                c_int(tag),
                c_char_p(arrangement.encode()),
                api_cornerTags_, apicornerTags_n_,
                byref(ierr))
            if ierr.value != 0 :
                raise ValueError(
        ...
        class field:
            ...
            def setNumbers(tag,option,value):
                ...
                """
                api_value_, apivalue_n_ = _ivectordouble(value)
                ierr = c_int()
                lib.gmshModelMeshFieldSetNumbers(
                    c_int(tag),
                    c_char_p(option.encode()),
                    api_value_, apivalue_n_,
                    byref(ierr))
                if ierr.value != 0 :
                    raise ValueError(
    ...
    class geo:
        ...
        @staticmethod
        def addPoint(x,y,z,meshSize,tag):
            """
        ...
        @staticmethod
        def addLine(startTag,endTag,tag):
            """
        ...
        @staticmethod
        def addCircleArc(startTag,centerTag,endTag,tag,nx,ny,nz):
            """
        ...
        @staticmethod
        def addEllipseArc(startTag,centerTag,majorTag,endTag,tag,nx,ny,nz):
            """
        ...
        def addLineLoop(edgeTags,tag):
            ...
            return int
            """
            api_edgeTags_, apiedgeTags_n_ = _ivectorint(edgeTags)
            ierr = c_int()
            api__result__ = lib.gmshModelGeoAddLineLoop(
                api_edgeTags_, apiedgeTags_n_,
                c_int(tag),
                byref(ierr))
            if ierr.value != 0 :
                raise ValueError(
        ...
        @staticmethod
        def addPlaneSurface(wireTags,tag):
            """
            ...
            return int
            """
            api_wireTags_, apiwireTags_n_ = _ivectorint(wireTags)
            ierr = c_int()
            api__result__ = lib.gmshModelGeoAddPlaneSurface(
                api_wireTags_, apiwireTags_n_,
                c_int(tag),
                byref(ierr))
            if ierr.value != 0 :
                raise ValueError(
        ...
        @staticmethod
        def addSurfaceFilling(wireTags,tag,sphereCenterTag):
            """
        ...
        @staticmethod
        def addSurfaceLoop(faceTags,tag):
            """
            ...
            return int
            """
            api_faceTags_, apifaceTags_n_ = _ivectorint(faceTags)
            ierr = c_int()
            api__result__ = lib.gmshModelGeoAddSurfaceLoop(
                api_faceTags_, apifaceTags_n_,
                c_int(tag),
                byref(ierr))
            if ierr.value != 0 :
                raise ValueError(
        ...
        def addVolume(shellTags,tag):
            ...
            return int
            """
            api_shellTags_, apishellTags_n_ = _ivectorint(shellTags)
            ierr = c_int()
            api__result__ = lib.gmshModelGeoAddVolume(
                api_shellTags_, apishellTags_n_,
                c_int(tag),
                byref(ierr))
            if ierr.value != 0 :
                raise ValueError(
        ...
        @staticmethod
        def extrude(dimTags,dx,dy,dz,numElements,heights,recombine):
            """
            ...
            api_dimTags_, apidimTags_n_ = _ivectorpair(dimTags)
            api_outDimTags_, api_outDimTags_n_ = POINTER(c_int)(), c_size_t()
            api_numElements_, apinumElements_n_ = _ivectorint(numElements)
            api_heights_, apiheights_n_ = _ivectordouble(heights)
            ierr = c_int()
            lib.gmshModelGeoExtrude(
                ...
                c_double(dz),
                byref(api_outDimTags_), byref(api_outDimTags_n_),
                api_numElements_, apinumElements_n_,
                api_heights_, apiheights_n_,
        ...
        @staticmethod
        def revolve(dimTags,x,y,z,ax,ay,az,angle,numElements,heights,recombine):
            """
        ...
        @staticmethod
        def twist(dimTags,x,y,z,dx,dy,dz,ax,ay,az,angle,numElements,heights,recombine):
            """
        ...
        class mesh:
            ...
            @staticmethod
            def setTransfiniteLine(tag,nPoints,type,coef):
                """
                Sets a transfinite meshing constraint on the line `tag', with `numVertices'
                mesh vertices distributed according to `type' and `coef'. Currently
                supported types are "Progression" (geometrical progression with power
    ...
    class occ:
        ...
        @staticmethod
        def addCircleArc(startTag,centerTag,endTag,tag):
            """
        ...
        @staticmethod
        def addCircle(x,y,z,r,tag,angle1,angle2):
            """
            TODO
        ...
        @staticmethod
        def addEllipseArc(startTag,centerTag,endTag,tag):
            """
            TODO
        ...
        @staticmethod
        def addEllipse(x,y,z,r1,r2,tag,angle1,angle2):
            """
            TODO
        ...
        @staticmethod
        def addWire(edgeTags,tag,checkClosed):
            """
            TODO
        ...
        @staticmethod
        def addRectangle(x,y,z,dx,dy,tag,roundedRadius):
            """
            TODO
        ...
        @staticmethod
        def addDisk(xc,yc,zc,rx,ry,tag):
            """
            TODO
        ...
        @staticmethod
        def addSurfaceFilling(wireTag,tag):
            """
            TODO
        ...
        @staticmethod
        def addSphere(xc,yc,zc,radius,tag,angle1,angle2,angle3):
            """
            TODO
        ...
        @staticmethod
        def addCylinder(x,y,z,dx,dy,dz,r,tag,angle):
            """
            TODO
        ...
        @staticmethod
        def addCone(x,y,z,dx,dy,dz,r1,r2,tag,angle):
            """
            TODO
        ...
        @staticmethod
        def addWedge(x,y,z,dx,dy,dz,tag,ltx):
            """
            TODO
        ...
        @staticmethod
        def addTorus(x,y,z,r1,r2,tag,angle):
            """
            TODO
        ...
        @staticmethod
        def addThruSections(wireTags,tag,makeSolid,makeRuled):
            """
            TODO
        ...
        @staticmethod
        def addThickSolid(solidTag,excludeFaceTags,offset,tag):
            """
            TODO

            return int, outDimTags
            """
            api_excludeFaceTags_, apiexcludeFaceTags_n_ = _ivectorint(excludeFaceTags)
            api_outDimTags_, api_outDimTags_n_ = POINTER(c_int)(), c_size_t()
            ierr = c_int()
            api__result__ = lib.gmshModelOccAddThickSolid(
                c_int(solidTag),
                api_excludeFaceTags_, apiexcludeFaceTags_n_,
                c_double(offset),
                byref(api_outDimTags_), byref(api_outDimTags_n_),
                c_int(tag),
                byref(ierr))
        ...
        @staticmethod
        def fillet(regionTags,edgeTags,radius,removeRegion):
            """
            TODO

            return outDimTags
            """
            api_regionTags_, apiregionTags_n_ = _ivectorint(regionTags)
            api_edgeTags_, apiedgeTags_n_ = _ivectorint(edgeTags)
            api_outDimTags_, api_outDimTags_n_ = POINTER(c_int)(), c_size_t()
            ierr = c_int()
            lib.gmshModelOccFillet(
                api_regionTags_, apiregionTags_n_,
                api_edgeTags_, apiedgeTags_n_,
                c_double(radius),
                byref(api_outDimTags_), byref(api_outDimTags_n_),
        ...
        @staticmethod
        def booleanUnion(objectDimTags,toolDimTags,tag,removeObject,removeTool):
            """
            TODO

            return int, outDimTags, outDimTagsMap
            """
            api_objectDimTags_, apiobjectDimTags_n_ = _ivectorpair(objectDimTags)
            api_toolDimTags_, apitoolDimTags_n_ = _ivectorpair(toolDimTags)
            api_outDimTags_, api_outDimTags_n_ = POINTER(c_int)(), c_size_t()
            ...
            api__result__ = lib.gmshModelOccBooleanUnion(
                api_objectDimTags_, apiobjectDimTags_n_,
                api_toolDimTags_, apitoolDimTags_n_,
                byref(api_outDimTags_), byref(api_outDimTags_n_),
        ...
        @staticmethod
        def booleanIntersection(objectDimTags,toolDimTags,tag,removeObject,removeTool):
            """
            TODO
        ...
        @staticmethod
        def booleanDifference(objectDimTags,toolDimTags,tag,removeObject,removeTool):
            """
            TODO
        ...
        @staticmethod
        def booleanFragments(objectDimTags,toolDimTags,tag,removeObject,removeTool):
            """
            TODO
        ...
        @staticmethod
        def importShapes(fileName,highestDimOnly,format):
            """
            TODO
...
class view:
    ...
    @staticmethod
    def addModelData(tag,modelName,dataType,tags,data,step,time,numComponents,partition):
        """
    ...
    def addListData(tag,type,numEle,data):
        ...
        """
        api_data_, apidata_n_ = _ivectordouble(data)
        ierr = c_int()
        lib.gmshViewAddListData(
            c_int(tag),
            c_char_p(type.encode()),
            c_int(numEle),
            api_data_, apidata_n_,
            byref(ierr))
        if ierr.value != 0 :
            raise ValueError(
    ...
    @staticmethod
    def probe(tag,x,y,z,step,numComp,gradient,tolerance,xElemCoord,yElemCoord,zElemCoord):
        """
        ...
        api_xElemCoord_, apixElemCoord_n_ = _ivectordouble(xElemCoord)
        api_yElemCoord_, apiyElemCoord_n_ = _ivectordouble(yElemCoord)
        api_zElemCoord_, apizElemCoord_n_ = _ivectordouble(zElemCoord)
        ierr = c_int()
        lib.gmshViewProbe(
            c_int(tag),
            c_double(x),
            ...
            c_int(bool(gradient)),
            c_double(tolerance),
            api_xElemCoord_, apixElemCoord_n_,
            api_yElemCoord_, apiyElemCoord_n_,
            api_zElemCoord_, apizElemCoord_n_,
            byref(ierr))
        if ierr.value != 0 :
            raise ValueError(
