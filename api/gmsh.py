...
class model:
    ...
    class mesh:
        ...
        @staticmethod
        def getElementQualities(elementTags, qualityName="minSJ", task=0, numTasks=1):
            """
            ...
            elements. `qualityName' is the quality mesure requested ("minSJ" for the
            minimal scaled jacobien, "minSICN" for the minimal signed inverted
            condition number and "minSIGE" for the signed inverted gradient error.
            Default is "minSJ"). 'elementQuality' is a vector containing qualities of
            elements in 'elementTags', in the same order as 'elementTags'. If
            `numTasks' > 1, only compute and return the part of the data indexed by
            `task'.
            ...
            api_elementQualities_, api_elementQualities_n_ = POINTER(c_double)(), c_size_t()
            ierr = c_int()
            lib.gmshModelMeshGetElementQualities(
                api_elementTags_, api_elementTags_n_,
                byref(api_elementQualities_), byref(api_elementQualities_n_),
            ...
            if ierr.value != 0:
                raise Exception(logger.getLastError())
            return _ovectordouble(api_elementQualities_, api_elementQualities_n_.value)
