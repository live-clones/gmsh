 ...
 *
 * This file defines the Gmsh C API (v4.14.2).
 *
...
#define GMSH_API_VERSION "4.14.2"
...
GMSH_API void gmshAlgorithmTetrahedralize(double ** coordinates, size_t * coordinates_n,
