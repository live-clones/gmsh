...
/*
 * This file defines the Gmsh C API (v4.8.1).
 *
 ...
 * `numTasks' > 1, only compute and return the part of the data indexed by
 * `task'. */
GMSH_API void gmshModelMeshGetElementQualities(size_t * elementTags, size_t elementTags_n,
                                               double ** elementQualities, size_t * elementQualities_n,
