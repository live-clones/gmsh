...
mesh.add('getBasisFunctions', doc, None, iint('elementType'), ivectordouble('integrationPoints'), istring('functionSpaceType'), oint('numComponents'), ovectordouble('basisFunctions'), oint('numFunctionsPerElement'), oint('numOrientations'))
...
mesh.add('getBasisFunctionsOrientationForElements', doc, None, iint('elementType'), ivectordouble('integrationPoints'), istring('functionSpaceType'), ovectorint('basisFunctionsOrientation'), iint('tag','-1'), isize('task', '0'), isize('numTasks', '1'))
