...
doc = '''Get the properties of an element of type `elementType': its name (`elementName'), dimension (`dim'), order (`order'), number of nodes (`numNodes') and node's coordinates in the reference element (`coordinates' vector, of length `dim' times `numNodes').'''
