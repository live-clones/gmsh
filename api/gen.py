...
doc = '''Get the basis functions of the elements of type `elementType' for the given `integrationType' integration rule and `functionSpaceType' (e.g. for 3rd order hierarchical H1 functions: "Solin0Form3" or "GradSolin0Form3"). `basisFunctions' contains the evaluation of the basis functions at the integration points: [g1e1f1, ..., g1e1fC, g1e2f1, ...,g1e2fC, g1enfC, g2e1f1, ...]. the u, v, w coordinates of the integration points in the reference element as well as the associated weight q, concatenated: [g1u, g1v, g1w, g1q, g2u, ...]. `numComponents' returns the number C of components of a basis function. Warning: this is an experimental feature and will probably change in a future release.'''
...
doc = '''Generate `keys' for the elements of type `elementType' for the given entity 'tag' and `functionSpaceType' (e.g. "Solin0Form3"). Each keyuniquely identifies a basis function. `coord' is a vector that contains x, y, z coordinates locating basis functions for sorting purposes.  Warning: this is an experimental feature and will probably change in a future release.'''
