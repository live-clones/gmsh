...
mesh.add('getCompressedBasisFunctionsForElements', doc, None, iint('elementType'), ivectordouble('integrationPoints'), istring('functionSpaceType'), oint('numComponents'), oint('numFunctionsPerElements'), ovectordouble('basisFunctions'), ovectorint('basisFunctionsIndex'), iint('tag','-1'), isize('task', '0'), isize('numTasks', '1'))

doc = '''Preallocate data before calling `getCompressedBasisFunctionsForElements' with `numTasks' > 1. For C and C++ only.'''
mesh.add_special('preallocateCompressedBasisFunctions', doc, ['onlycc++'], None, iint('elementType'), ivectordouble('integrationPoints'), istring('functionSpaceType'), ovectordouble('basisFunctions'), ovectorint('basisFunctionsIndex'), iint('tag', '-1'))
