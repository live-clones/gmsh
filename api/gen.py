...
doc = '''Get the basis function of the element of type `elementType' for the given `integrationType' integration rule and `functionSpaceType' (e.g. for order 3 : "Solin0Form3" or "GradSolin0Form3" ) . 'basisFunctions' contains the evaluation of de the basis functions at the integration points: [{gausspoint_1}:e1f1, ..., e1fC, e2f1, ..,e2fC.,enfC,{gausspoint_2}:...]. 'integrationPoints' contains the Gauss weights and integration points. `numComponents' returns the number C of components of a basis function. Each physical mesh edge (or Face) will  be assigned a unique orientation,and all edges (or Faces) of physical mesh will be equipped with an orientation tag , indicating whether the image of the corresponding edge (or Face) of the reference domain through the reference map has the same or opposite orientation.The global edge orientation always pointing from the vertex with the lower global vertex number to the one with the higher one.  '''
mesh.add('getBasisFunctionsForElements',doc,None,istring('integrationType'),iint('elementType'),istring('functionSpaceType'),ovectordouble('basisFunctions'),ovectordouble('integrationPoints'),oint('numComponents'),oint('numDofsByElement'),iint('tag','-1'))
...
doc = ''' generate the vectorpair 'Keys' of the element of type `elementType' for the given entity 'tag' and `functionSpaceType' (e.g. for order 3 : "Solin0Form3" ) . Each element of 'Keys' numbers a dof. `coord' is a vector that contains the x, y, z coordinates of the dof   '''
mesh.add('getKeyForElements',doc,None,iint('dim'),iint('tag'),istring('functionSpaceType'),iint('elementType'),ibool('generateCoord'),ovectordouble('coord'),ovectorpair('keys'))
