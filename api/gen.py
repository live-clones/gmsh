...
view.add('addModelData',doc,None,iint('tag'),istring('modelName'),istring('dataType'),ivectorint('tags'),ivectorvectordouble('data'),iint('step','0'),idouble('time','0.'),iint('numComponents','-1'),iint('partition','0'))
