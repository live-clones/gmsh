...
doc = '''Get the Jacobian data for mesh elements of the entity of dimension `dim' and `tag' tag. The data is returned by element type and by element, in the same order as the data returned by `getElements'. `integrationType' specifies the type of integration (e.g. \"Gauss4\"). `nbrIntegrationPoints' contains for each element type, the number of integration points that corresponds to `integrationType'. `jacobiansAndDeterminants' contains for each element type a vector (of size 9 times the number of integration points) containing the 9 entries (by row) of the 3x3 Jacobian matrix and the determinant of the Jacobian at the 9th position.'''
mesh.add('getJacobianData',doc,None,istring('integrationType'),ovectorint('nbrIntegrationPoints'),ovectorvectordouble('jacobiansAndDeterminants'),iint('dim', '-1'),iint('tag', '-1'))
...
mesh.add('getJacobianDataByType',doc,None,iint('elementType'),istring('integrationType'),oint('nbrIntegrationPoints'),ovectordouble('jacobiansAndDeterminants'),iint('dim', '-1'),iint('tag', '-1'),iint('myThread', '0'),iint('nbrThreads', '1'))
