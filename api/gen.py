...
mesh.add('getBasisFunctionsForElements',doc,None,istring('integrationType'),iint('elementType'),ovectordouble('basisFunctions'),ovectordouble('integrationPoints'),istring('functionSpaceType'),iint('order'),ovectorpair('keys'),oint('numDof'),ibool('belongBoundary'),iint('tag','-1'),)
...
mesh.add('getKeyForElements',doc,None,ovectorpair('keys'),iint('dim'),iint('tag'),iint('order'),ovectordouble('coord'),ibool('belongBoundary'))
