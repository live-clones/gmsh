...
mesh.add('getKeysForElements',doc,None,iint('elementType'),istring('functionSpaceType'),oint('nbrKeysByElements'),ovectorpair('keys'),ovectordouble('coord'),iint('tag', '-1'),ibool('returnCoord','true', 'True'))
