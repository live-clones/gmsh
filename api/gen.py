...
mesh.add('getElementEdgeNodesCoord', doc, None, iint('elementType'), ovectorsize('nodeTags'), ovectordouble('coord'), iint('tag', '-1'),  ibool('primary', 'false', 'False'), isize('task', '0'), isize('numTasks', '1'))
