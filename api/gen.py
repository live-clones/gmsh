...
doc = '''Get the element-dependent basis functions of the elements of type `elementType' in the entity of tag `tag', for the given `integrationType' integration rule (e.g. "Gauss4" for a Gauss quadrature suited for integrating 4th order polynomials) and `functionSpaceType' function space (e.g. "H1Legendre3" or "GradH1Legendre3" for 3rd order hierarchical H1 Legendre functions or their gradient, in the u, v, w coordinates of the reference elements). `integrationPoints' contains the u, v, w coordinates of the integration points in the reference element as well as the associated weight q, concatenated: [g1u, g1v, g1w, g1q, g2u, ...]. `numComponents' returns the number C of components of a basis function. `numBasisFunctions' returns the number of basis functions per element. `basisFunctions' returns the value of the basis functions at the integration points for each element: [g1e1f1, ..., g1e1fC, g1e2f1, ...,g1e2fC, g1enfC, g2e1f1, ...]. Warning: this is an experimental feature and will probably change in a future release.'''
mesh.add('getBasisFunctionsForElements',doc,None,iint('elementType'),istring('integrationType'),istring('functionSpaceType'),ovectordouble('integrationPoints'),oint('numComponents'),oint('numFunctionsPerElements'),ovectordouble('basisFunctions'),iint('tag','-1'))

doc = '''Generate the `keys' for the elements of type `elementType' in the entity of tag `tag',for the `functionSpaceType' function space. Each key uniquely identifies a basis function in the function space. `coord' is a vector that contains x, y, z coordinates locating basis functions for sorting purposes. Warning: this is an experimental feature and will probably change in a future release.'''
mesh.add('getKeysForElements',doc,None,iint('elementType'),istring('functionSpaceType'),ovectorpair('keys'),ovectordouble('coord'),iint('tag', '-1'),ibool('generateCoord', 'true', 'True'))
