...
mesh.add('getBasisFunctionsForElements',doc,None,istring('integrationType'),iint('elementType'),ovectordouble('basisFunctions'),ovectordouble('weight'),istring('functionSpaceType'),iint('order'),ovectorpair('keys'),oint('numDof'),ibool('belongBoundary'),iint('tag','-1'),)
