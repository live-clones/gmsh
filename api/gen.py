...
mesh.add('getBasisFunctions', doc, None, iint('elementType'), ivectordouble('integrationPoints'), istring('functionSpaceType'), oint('numComponents'), oint('numOrientations'), ovectordouble('basisFunctions'), oint('numFunctionsPerElement'))
