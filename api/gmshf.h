...
!  hxt meshing test.
        subroutine gmshModelMeshCreateHxtMesh(
     &      inputMesh,
     &      coord,
     &      coord_n,
     &      outputMesh,
     ...
     &    bind(C, name = "gmshModelMeshCreateHxtMesh")
          use, intrinsic :: iso_c_binding
            character(len = 1, kind = c_char)::inputMesh(*)
            real(c_double)::coord(*)
            integer(c_size_t), value :: coord_n
            character(len = 1, kind = c_char)::outputMesh(*)
            type(c_ptr), intent(out)::pts
            integer(c_size_t) :: pts_n
            type(c_ptr), intent(out)::tets
            integer(c_size_t) :: tets_n
            integer(c_int)::ierr
