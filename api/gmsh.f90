...
!
! This file defines the Gmsh Fortran API (v4.12.0).
!
...
module gmsh
  ...
  character(len=100), parameter, public :: GMSH_API_VERSION = "4.12.0"
  ...
  subroutine gmshModelMeshComputeAlphaShape3D(dim, &
                                              alphaShapeTags, &
                                              alpha, &
                                              hMean, &
                                              sizeFieldCallback, &
    ...
    subroutine C_API(dim, &
                     ...
                     refine, &
                     ierr_) &
      bind(C, name="gmshModelMeshComputeAlphaShape3D")
      use, intrinsic :: iso_c_binding
      integer(c_int), value, intent(in) :: dim
