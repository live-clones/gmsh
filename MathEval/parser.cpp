...
{
      16,    12,     0,     3,     0,     4,     0,    16,     7,    16,
       0,    16,     6,    16,     0,    16,     8,    16,     0,    16,
       9,    16,     0,     6,    16,     0,    16,    11,    16,     0,
       5,    13,    16,    14,     0,    13,    16,    14,     0
};
...
{
  "$", "error", "$undefined.", "NUMBER", "VARIABLE", "FUNCTION", "'-'", 
  "'+'", "'*'", "'/'", "NEG", "'^'", "'\\n'", "'('", "')'", "input", 
  "expression", 0
};
#endif
...
{
       8,-32768,-32768,   -11,     8,     8,    27,     8,    -7,     9,
       8,     8,     8,     8,     8,-32768,    18,-32768,    32,    32,
      -7,    -7,-32768,-32768,     5,    19,-32768
};
...
{
       8,     9,     7,    16,    14,    25,    18,    19,    20,    21,
      22,     1,     2,     3,     4,    10,    11,    12,    13,    26,
      14,     5,     0,    17,    10,    11,    12,    13,     0,    14,
       0,     0,    23,    10,    11,    12,    13,     0,    14,    15,
      12,    13,     0,    14
};

static const short yycheck[] =
{
       4,     5,    13,     7,    11,     0,    10,    11,    12,    13,
      14,     3,     4,     5,     6,     6,     7,     8,     9,     0,
      11,    13,    -1,    14,     6,     7,     8,     9,    -1,    11,
      -1,    -1,    14,     6,     7,     8,     9,    -1,    11,    12,
       8,     9,    -1,    11
};
