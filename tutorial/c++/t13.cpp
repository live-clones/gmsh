...
int main(int argc, char **argv)
{
  ...
  auto createGeometryAndMesh = []()
  {
    ...
    // handle dense STL meshes coming from e.g. imaging systems / where no CAD
    // is available; it is less well suited for the poor quality STL
    // triangulations (optimized for size, with e.g. very elongated triangles)
    // that are usually generated by CAD tools for e.g. 3D printing.
