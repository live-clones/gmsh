...
files=`git grep -l '(C) 1997-2025 C. Geuzaine'`

for file in $files; do
  echo "modifying $file"
  sed -i '' -e "s/(C) 1997-2024 C\. Geuzaine/(C) 1997-2025 C\. Geuzaine/g" $file
done

files=`git grep -l '(C) 2013-2025 UCLouvain-ULiege'`

for file in $files; do
  echo "modifying $file"
  sed -i '' -e "s/(C) 2013-2025 UCLouvain-ULiege/(C) 2013-2025 UCLouvain-ULiege/g" $file
done
