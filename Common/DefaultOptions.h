...
StringXNumber MeshOptions_Number[] = {
  ...
  { F|O, "MetisEdgeMatching" , opt_mesh_partition_metis_edge_matching, 2. ,
    "(Adv. METIS): Determines the matching type (1=Random, 2=Sorted Heavy-Edge)" },
  { F|O, "MetisRefinementAlgorithm" , opt_mesh_partition_metis_refine_algorithm, 2. ,
    "(Adv. METIS): Algorithm for k-way refinement (1=FM-based cut, 2=Greedy, "
  ...
  { F|O, "NbPartitions" , opt_mesh_partition_num, 2. ,
