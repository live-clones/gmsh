...
namespace {
  ...
  std::vector<CGNS::ElementType_t> msh2CgnsEltTypeInit()
  {
    std::vector<CGNS::ElementType_t> cgnsType(MSH_MAX_NUM + 1,
                                              CGNS::ElementTypeNull);

    // All orders
    cgnsType[MSH_PNT] = CGNS::NODE;

    // Linear elements
    cgnsType[MSH_LIN_2] = CGNS::BAR_2;
    cgnsType[MSH_TRI_3] = CGNS::TRI_3;
    cgnsType[MSH_QUA_4] = CGNS::QUAD_4;
    cgnsType[MSH_TET_4] = CGNS::TETRA_4;
    cgnsType[MSH_PYR_5] = CGNS::PYRA_5;
    cgnsType[MSH_PRI_6] = CGNS::PENTA_6;
    cgnsType[MSH_HEX_8] = CGNS::HEXA_8;

    // Quadratic elements
    cgnsType[MSH_LIN_3] = CGNS::BAR_3;
    cgnsType[MSH_TRI_6] = CGNS::TRI_6;
    cgnsType[MSH_QUA_8] = CGNS::QUAD_8;
    cgnsType[MSH_QUA_9] = CGNS::QUAD_9;
    cgnsType[MSH_TET_10] = CGNS::TETRA_10;
    cgnsType[MSH_PYR_13] = CGNS::PYRA_13;
    cgnsType[MSH_PYR_14] = CGNS::PYRA_14;
    cgnsType[MSH_PRI_15] = CGNS::PENTA_15;
    cgnsType[MSH_PRI_18] = CGNS::PENTA_18;
    cgnsType[MSH_HEX_20] = CGNS::HEXA_20;
    cgnsType[MSH_HEX_27] = CGNS::HEXA_27;

    // Cubic elements
    cgnsType[MSH_LIN_4] = CGNS::BAR_4;
    cgnsType[MSH_TRI_9] = CGNS::TRI_9;
    cgnsType[MSH_TRI_10] = CGNS::TRI_10;
    cgnsType[MSH_QUA_12] = CGNS::QUAD_12;
    cgnsType[MSH_QUA_16] = CGNS::QUAD_16;
    cgnsType[MSH_TET_16] = CGNS::TETRA_16;
    cgnsType[MSH_TET_20] = CGNS::TETRA_20;
    cgnsType[MSH_PYR_21] = CGNS::PYRA_21;
    cgnsType[MSH_PYR_29] = CGNS::PYRA_29;
    cgnsType[MSH_PYR_30] = CGNS::PYRA_30;
    cgnsType[MSH_PRI_24] = CGNS::PENTA_24;
    //  cgnsType[MSH_PRI_38] = CGNS::PENTA_38;
    cgnsType[MSH_PRI_40] = CGNS::PENTA_40;
    cgnsType[MSH_HEX_32] = CGNS::HEXA_32;
    cgnsType[MSH_HEX_56] = CGNS::HEXA_56;
    cgnsType[MSH_HEX_64] = CGNS::HEXA_64;

    // Quartic elements
    cgnsType[MSH_LIN_5] = CGNS::BAR_5;
    cgnsType[MSH_TRI_12] = CGNS::TRI_12;
    cgnsType[MSH_TRI_15] = CGNS::TRI_15;
    cgnsType[MSH_QUA_16] = CGNS::QUAD_16;
    cgnsType[MSH_QUA_25] = CGNS::QUAD_25;
    cgnsType[MSH_TET_22] = CGNS::TETRA_22;
    cgnsType[MSH_TET_34] = CGNS::TETRA_34;
    cgnsType[MSH_TET_35] = CGNS::TETRA_35;
    cgnsType[MSH_PYR_29] = CGNS::PYRA_29;
    //  cgnsType[MSH_PYR_50] = CGNS::PYRA_50;
    cgnsType[MSH_PYR_55] = CGNS::PYRA_55;
    cgnsType[MSH_PRI_33] = CGNS::PENTA_33;
    //  cgnsType[MSH_PRI_66] = CGNS::PENTA_66;
    cgnsType[MSH_PRI_75] = CGNS::PENTA_75;
    cgnsType[MSH_HEX_44] = CGNS::HEXA_44;
    //  cgnsType[MSH_HEX_98] = CGNS::HEXA_98;
    cgnsType[MSH_HEX_125] = CGNS::HEXA_125;
  ...
  std::vector<int> cgns2MshEltTypeInit()
  {
    ...
    // All orders
    mshType[CGNS::NODE] = MSH_PNT;

    // Linear elements
    mshType[CGNS::BAR_2] = MSH_LIN_2;
    mshType[CGNS::TRI_3] = MSH_TRI_3;
    mshType[CGNS::QUAD_4] = MSH_QUA_4;
    mshType[CGNS::TETRA_4] = MSH_TET_4;
    mshType[CGNS::PYRA_5] = MSH_PYR_5;
    mshType[CGNS::PENTA_6] = MSH_PRI_6;
    mshType[CGNS::HEXA_8] = MSH_HEX_8;

    // Quadratic elements
    mshType[CGNS::BAR_3] = MSH_LIN_3;
    mshType[CGNS::TRI_6] = MSH_TRI_6;
    mshType[CGNS::QUAD_8] = MSH_QUA_8;
    mshType[CGNS::QUAD_9] = MSH_QUA_9;
    mshType[CGNS::TETRA_10] = MSH_TET_10;
    mshType[CGNS::PYRA_13] = MSH_PYR_13;
    mshType[CGNS::PYRA_14] = MSH_PYR_14;
    mshType[CGNS::PENTA_15] = MSH_PRI_15;
    mshType[CGNS::PENTA_18] = MSH_PRI_18;
    mshType[CGNS::HEXA_20] = MSH_HEX_20;
    mshType[CGNS::HEXA_27] = MSH_HEX_27;

    // Cubic elements
    mshType[CGNS::BAR_4] = MSH_LIN_4;
    mshType[CGNS::TRI_9] = MSH_TRI_9;
    mshType[CGNS::TRI_10] = MSH_TRI_10;
    mshType[CGNS::QUAD_12] = MSH_QUA_12;
    mshType[CGNS::QUAD_16] = MSH_QUA_16;
    mshType[CGNS::TETRA_16] = MSH_TET_16;
    mshType[CGNS::TETRA_20] = MSH_TET_20;
    mshType[CGNS::PYRA_21] = MSH_PYR_21;
    mshType[CGNS::PYRA_29] = MSH_PYR_29;
    mshType[CGNS::PYRA_30] = MSH_PYR_30;
    mshType[CGNS::PENTA_24] = MSH_PRI_24;
    //  mshType[CGNS::PENTA_38] = MSH_PRI_38;
    mshType[CGNS::PENTA_40] = MSH_PRI_40;
    mshType[CGNS::HEXA_32] = MSH_HEX_32;
    mshType[CGNS::HEXA_56] = MSH_HEX_56;
    mshType[CGNS::HEXA_64] = MSH_HEX_64;

    // Quartic elements
    mshType[CGNS::BAR_5] = MSH_LIN_5;
    mshType[CGNS::TRI_12] = MSH_TRI_12;
    mshType[CGNS::TRI_15] = MSH_TRI_15;
    mshType[CGNS::QUAD_16] = MSH_QUA_16;
    mshType[CGNS::QUAD_25] = MSH_QUA_25;
    mshType[CGNS::TETRA_22] = MSH_TET_22;
    mshType[CGNS::TETRA_34] = MSH_TET_34;
    mshType[CGNS::TETRA_35] = MSH_TET_35;
    mshType[CGNS::PYRA_29] = MSH_PYR_29;
    //  mshType[CGNS::PYRA_50] = MSH_PYR_50;
    mshType[CGNS::PYRA_55] = MSH_PYR_55;
    mshType[CGNS::PENTA_33] = MSH_PRI_33;
    //  mshType[CGNS::PENTA_66] = MSH_PRI_66;
    mshType[CGNS::PENTA_75] = MSH_PRI_75;
    mshType[CGNS::HEXA_44] = MSH_HEX_44;
    //  mshType[CGNS::HEXA_98] = MSH_HEX_98;
    mshType[CGNS::HEXA_125] = MSH_HEX_125;
...
{
  static std::vector<CGNS::ElementType_t> cgnsType = msh2CgnsEltTypeInit();

  if(mshTag >= static_cast<int>(cgnsType.size())) return CGNS::ElementTypeNull;
  return cgnsType[mshTag];
}

// CGNS to msh element type
int cgns2MshEltType(CGNS::ElementType_t cgnsType)
{
