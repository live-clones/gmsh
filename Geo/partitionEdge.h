...
private:
  ...
  GEdge *_parentEntity;
public:
  partitionEdge(GModel *model, int num, GVertex *_v0, GVertex *_v1, const std::vector<unsigned int> &partitions) : discreteEdge(model, num, _v0, _v1), _partitions(partitions), _parentEntity(NULL) {}
