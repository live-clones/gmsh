...
if(NOT status EQUAL 0)
  message(FATAL_ERROR
    "QuadCleanUp quality-only mixed-swap driver failed:\n${log}")
endif()
...
if(NOT first_summary MATCHES "1 topology changes" OR
  ...
  message(FATAL_ERROR
    "QuadCleanUp did not accept the quality-only mixed swap:\n${log}")
endif()
if(NOT second_summary MATCHES "0 topology changes" OR
   NOT second_summary MATCHES "preferred violations 0 -> 0")
  message(FATAL_ERROR
    "QuadCleanUp mixed quality result is not a fixed point:\n${log}")
endif()

string(REGEX MATCHALL "QuadCleanUp decisions: [^\n\r]*" decisions "${log}")
list(GET decisions 0 first_decisions)
if(NOT first_decisions MATCHES "other=1")
  message(FATAL_ERROR
    "The mixed quality swap did not use OtherImprovement:\n${log}")
endif()
