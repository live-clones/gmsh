...
if(NOT status EQUAL 0)
  message(FATAL_ERROR "OptimizeQuadsFast diamond driver failed:\n${log}")
endif()
...
if(NOT first_summary MATCHES "1 topology changes" OR
   NOT first_summary MATCHES "bad elements 1 -> 0")
  message(FATAL_ERROR "Fast did not collapse the bad diamond:\n${log}")
endif()
if(NOT second_summary MATCHES "0 topology changes" OR
   NOT second_summary MATCHES "bad elements 0 -> 0")
  message(FATAL_ERROR "The collapsed diamond is not a fixed point:\n${log}")
endif()
