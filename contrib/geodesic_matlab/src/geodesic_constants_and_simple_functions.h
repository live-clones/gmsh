...
#define M_PI 3.14159265358979323846
  ...
  double const SMALLEST_INTERVAL_RATIO = 1e-12;
  // double const SMALL_EPSILON = 1e-10;

  inline double
  cos_from_edges(double const a, // compute the cosine of the angle given the
  ...
  inline bool read_mesh_from_file(const char *filename, Points &points,
                                  Faces &faces)
  {
