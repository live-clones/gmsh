                                            ...
                                            uint32_t *isBoundary)
{
  ...
  // TODO delete
  if(opt->verbosity>=2){
    hxtMeshWriteGmsh(mesh,"splitted7invalid.msh");
    FILE *test;
    hxtPosInit("binEdgesQuadSplit7invalid.pos","edges",&test);
                                           ...
                                           uint32_t *bin)
{
  ...
  HXT_INFO_COND(opt->verbosity>=1,"--- Removing flat quads on the boundary ");
