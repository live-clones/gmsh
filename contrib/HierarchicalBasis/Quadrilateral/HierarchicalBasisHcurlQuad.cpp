...
double HierarchicalBasisHcurlQuad::_affineCoordinate(int const &j, double const &u, double const &v) {
    switch(j) {
        case(1):
            return 0.5 * (1 + u);
        case(2):
...
void HierarchicalBasisHcurlQuad::generateHcurlBasis(double const &u, double const &v, double const &w,
...
void HierarchicalBasisHcurlQuad::orientEdge(int const &flagOrientation, int const &edgeNumber,
...
void HierarchicalBasisHcurlQuad::generateCurlBasis(double const &u, double const &v, double const &w,
                                                   std::vector<std::vector<double> > &edgeBasis,
                                                   std::vector<std::vector<double> > &faceBasis,
                                                   std::vector<std::vector<double> > &bubbleBasis) {
    double dlambda1 = 0.5;
...
void HierarchicalBasisHcurlQuad::orientOneFace(double const &u, double const &v, double const &w,
...
void HierarchicalBasisHcurlQuad::orientFace(int const &flag1, int const &flag2, int const &flag3, int const &faceNumber,
...
void HierarchicalBasisHcurlQuad::getKeysInfo(std::vector<int> &functionTypeInfo, std::vector<int> &orderInfo) {
    int it = 0;
