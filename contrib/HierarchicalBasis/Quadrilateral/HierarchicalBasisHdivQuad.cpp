...
double HierarchicalBasisHdivQuad::_affineCoordinate(int const &j, double const &u, double const &v) {
    switch(j) {
        case(1):
            return 0.5 * (1 + u);
        case(2):
...
void HierarchicalBasisHdivQuad::generateHdivBasis(double const &u, double const &v, double const &w,
    ...
    for(int i = 0; i < _nedge; i++) {
        ...
        for(int iedge = 0; iedge < _pOrderEdge[i] + 1; iedge++) {
            for(int j = 0; j < 3; j++) {
                edgeBasis[edgeIt][j] = lambda * legendreVector[uv][iedge] * direction[j];
            }
            edgeIt++;
        }
    }
    ...
    int faceIt = 0;
    for(int n1 = 0; n1 <= _pf[0]; n1++) {
        for(int n2 = 2; n2 <= _pf[1] + 1; n2++) {
            faceBasis[faceIt][0] = legendreVector[0][n1] * OrthogonalPoly::EvalLobatto(n2, v);
            faceBasis[faceIt][1] = 0;
            faceBasis[faceIt][2] = 0;
            faceIt++;
        }
    }
    for(int n1 = 2; n1 <= _pf[0] + 1; n1++) {
        for(int n2 = 0; n2 <= _pf[1]; n2++) {
            faceBasis[faceIt][0] = 0;
            faceBasis[faceIt][1] = legendreVector[1][n2] * OrthogonalPoly::EvalLobatto(n1, u);
            faceBasis[faceIt][2] = 0;
            faceIt++;
        }
    }
...
void HierarchicalBasisHdivQuad::orientEdge(int const &flagOrientation, int const &edgeNumber,
...
void HierarchicalBasisHdivQuad::orientEdgeFunctionsForNegativeFlag(std::vector<std::vector<double> > &edgeFunctions) {
    int constant1 = 0;
    int constant2 = 0;
...
void HierarchicalBasisHdivQuad::generateDivBasis(double const &u, double const &v, double const &w,
                                                   std::vector<std::vector<double> > &edgeBasis,
                                                   std::vector<std::vector<double> > &faceBasis,
                                                   std::vector<std::vector<double> > &bubbleBasis) {
    double dlambda1 = 0.5;
    ...
    for(int i = 0; i < _nedge; i++) {
        ...
        for(int iedge = 0; iedge < _pOrderEdge[i] + 1; iedge++) {
            for(int j = 0; j < 3; j++) {
                edgeBasis[edgeIt][j] = dlambda * legendreVector[uv][iedge] * direction[j];
            }
            edgeIt++;
        }
    }
    ...
    for(int n1 = 0; n1 <= _pf[0]; n1++) {
        for(int n2 = 2; n2 <= _pf[1] + 1; n2++) {
            faceBasis[faceIt][0] = 0;
            faceBasis[faceIt][1] = 0;
            faceBasis[faceIt][2] = -legendreVector[0][n1] * OrthogonalPoly::EvalDLobatto(n2, v);
            faceIt++;
        }
    }
    for(int n1 = 2; n1 <= _pf[0] + 1; n1++) {
        for(int n2 = 0; n2 <= _pf[1]; n2++) {
            faceBasis[faceIt][0] = 0;
            faceBasis[faceIt][1] = 0;
            faceBasis[faceIt][2] = legendreVector[1][n2] * OrthogonalPoly::EvalDLobatto(n1, u);
            faceIt++;
        }
    }
}

void HierarchicalBasisHdivQuad::orientOneFace(double const &u, double const &v, double const &w,
                                               int const &flag1, int const &flag2, int const &flag3, int const &faceNumber,
                                               std::vector<std::vector<double> > &faceFunctions, std::string typeFunction) {
    if(!(flag1 == 1 && flag2 == 1 && flag3 == 1)) {
        if(flag3 == 1) {
            int iterator = 0;
            for(int it1 = 0; it1 <= _pf[0]; it1++) {
                for(int it2 = 2; it2 <= _pf[1] + 1; it2++) {
                    int impactFlag1 = 1;
                    int impactFlag2 = 1;
                    if(flag1 == -1 && it1 % 2 == 0) {
                        impactFlag1 = -1;
                    ...
                    faceFunctions[iterator][0] = faceFunctions[iterator][0] * impactFlag1 * impactFlag2;
            ...
            for(int it1 = 2; it1 <= _pf[0] + 1; it1++) {
                for(int it2 = 0; it2 <= _pf[1]; it2++) {
                    int impactFlag1 = 1;
                    int impactFlag2 = 1;
                    if(flag1 == -1 && it1 % 2 != 0) {
                        impactFlag1 = -1;
            ...
            if(typeFunction == "HdivLegendre") {
                ...
                for(int it1 = 0; it1 <= _pf[1]; it1++) {
                    for(int it2 = 2; it2 <= _pf[0] + 1; it2++) {
                        int impactFlag1 = 1;
                        int impactFlag2 = 1;
                        if(flag2 == -1 && it1 % 2 == 0) {
                            impactFlag1 = -1;
                        ...
                        faceFunctions[iterator][1] = legendreVector[1][it1] * OrthogonalPoly::EvalLobatto(it2, u) * impactFlag1 * impactFlag2;
                        faceFunctions[iterator][2] = 0;
                        iterator++;
                    }
                }
                for(int it1 = 2; it1 <= _pf[1] + 1; it1++) {
                    for(int it2 = 0; it2 <= _pf[0]; it2++) {
                        int impactFlag1 = 1;
                        int impactFlag2 = 1;
                        if(flag2 == -1 && it1 % 2 != 0) {
                            impactFlag1 = -1;
                        ...
                        faceFunctions[iterator][0] = legendreVector[0][it2] * OrthogonalPoly::EvalLobatto(it1, v) * impactFlag1 * impactFlag2;
                ...
                for(int it1 = 0; it1 <= _pf[1]; it1++) {
                    for(int it2 = 2; it2 <= _pf[0] + 1; it2++) {
                        ...
                        faceFunctions[iterator][0] = 0;
                        faceFunctions[iterator][1] = 0;
                        faceFunctions[iterator][2] = legendreVector[1][it1] * OrthogonalPoly::EvalDLobatto(it2, u) * impactFlag1 * impactFlag2;
                        iterator++;
                    }
                }
                for(int it1 = 2; it1 <= _pf[1] + 1; it1++) {
                    for(int it2 = 0; it2 <= _pf[0]; it2++) {
                        ...
                        faceFunctions[iterator][0] = 0;
                        faceFunctions[iterator][1] = 0;
                        faceFunctions[iterator][2] = -legendreVector[0][it2] * OrthogonalPoly::EvalDLobatto(it1, v) * impactFlag1 * impactFlag2;
                        iterator++;
                    }
                }
            }
...
void HierarchicalBasisHdivQuad::orientFace(int const &flag1, int const &flag2, int const &flag3, int const &faceNumber,
...
void HierarchicalBasisHdivQuad::getKeysInfo(std::vector<int> &functionTypeInfo, std::vector<int> &orderInfo) {
    int it = 0;
