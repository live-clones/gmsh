  ...
  if(_numQuadFaceFunction > 0) {
    for(int iOrientation = 0; iOrientation < 8; iOrientation++) {
      ...
      std::vector<std::vector<double>> orientedFaceFunction(
        _numQuadFaceFunction + _numTriFaceFunction, std::vector<double>(3, 0));
    ...
    for(int iOrientation = 0; iOrientation < 6; iOrientation++) {
      ...
      for(int r = 0; r < _numTriFaceFunction; r++) {
        triFaceFunctionsAllOrientation[it][0] =
          orientedFaceFunction[r + _numQuadFaceFunction][0];
        triFaceFunctionsAllOrientation[it][1] =
          orientedFaceFunction[r + _numQuadFaceFunction][1];
        triFaceFunctionsAllOrientation[it][2] =
          orientedFaceFunction[r + _numQuadFaceFunction][2];
        it++;
      }
    }
  }
