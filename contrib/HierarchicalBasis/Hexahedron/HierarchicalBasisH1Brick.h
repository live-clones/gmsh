...
private:
  std::array<int, 3> _pb; /*
                           ...
                           */
  std::array<int, 12> _pOrderEdge; // Edge functions order (pOrderEdge[0]
                                   // matches the order of the edge 0)

  std::array<std::array<int, 6>, 2>
    _pOrderFace; /*
  ...
  void
  _someProductGrad(double u, double v, double w,
