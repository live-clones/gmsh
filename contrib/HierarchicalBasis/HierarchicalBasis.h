...
public:
  ...
  virtual void generateBasis(
    ...
    std::vector<double> &vertexBasis, std::vector<double> &edgeBasis,
  ...
  virtual void generateBasis(
    ...
    std::string
      typeFunction) = 0; // typeFunction = GradH1Legendre, HcurlLegendre,
                         // curlHcurlLegendre, HdivLegendre
   ...
   *           "eTablePositiveFlag", which is generated by the "generateBasis"
   * method; "eTableNegativeFlag", which is generated by the
   * "orientEdgeFunctionsForNegativeFlag" method. The output is :
   * "edgeFunctions"
   */
