...
extern "C" {
  ...
  (JNIEnv *env, jclass c)
  {
    ...
    sstream << "<center><h3>Gmsh</h3>"
            ...
            << "<p>Copyright (C) 1997-2017 Christophe Geuzaine and Jean-Fran&ccedil;ois Remacle</p>"
  ...
  (JNIEnv *env, jclass c)
  {
    ...
    sstream << "<center><h3>GetDP</h3>"
            ...
            << "<p>Copyright (C) 1997-2017 Patrick Dular and Christophe Geuzaine, University of Li&egrave;ge</p>"
