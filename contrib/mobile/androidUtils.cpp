                                                                 ...
                                                                 jclass c)
{
  ...
  sstream << "<center><h3>Gmsh</h3>"
          ...
          << "<p>Copyright (C) 1997-2019 Christophe Geuzaine and "
                                                                  ...
                                                                  jclass c)
{
  ...
  sstream << "<center><h3>GetDP</h3>"
          ...
          << "<p>Copyright (C) 1997-2019 Patrick Dular and Christophe "
             "Geuzaine, University of Li&egrave;ge</p>"
          << "<p><a href=\"http://getdp.info/doc/CREDITS.txt\">Credits</a> "
          << "and <a href=\"http://getdp.info/doc/LICENSE.txt\">licensing "
             "information</a></p>"
