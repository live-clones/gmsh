    ...
    [self.aboutView
      loadHTMLString:
        [NSString stringWithFormat:
                    ...
                    @"h3>Version %@<p>Copyright (C) 2014-2019 Christophe "
                    ...
                    @"%s)<p>Copyright (C) 1997-2019 Christophe Geuzaine and "
                    @"Jean-Fran&ccedil;ois Remacle</p><p><a "
                    @"href=\"http://geuz.org/gmsh/doc/CREDITS.txt\">Credits</"
                    @"a> and <a "
                    @"href=\"http://geuz.org/gmsh/doc/LICENSE.txt\">licensing "
                    ...
                    @"date:</i> %s)<p>Copyright (C) 1997-2019 Patrick Dular "
                    @"and Christophe Geuzaine, University of "
                    @"Li&egrave;ge</p><p><a "
                    @"href=\"http://geuz.org/getdp/doc/CREDITS.txt\">Credits</"
                    @"a> and <a "
                    @"href=\"http://geuz.org/getdp/doc/LICENSE.txt\">licensing "
                    @"information</a></p><p><i>Build options:</i> "
                    @"%s</p><p>Visit <a "
